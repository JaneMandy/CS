...
public class Server implements Runnable {
   ...
   public void addIcmpListener(String var1, Server.IcmpListener var2) {
   ...
   public void run() {
      ...
      while(true) {
         ...
         synchronized(this.listeners) {
            Server.IcmpListener var8 = (Server.IcmpListener)this.listeners.get(var6);
            if (var8 == null) {
               var8 = (Server.IcmpListener)this.listeners.get("foob");
            }
