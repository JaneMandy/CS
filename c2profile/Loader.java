...
public class Loader {
   ...
   public Loader(String var1, String var2, Profile var3) {
      ...
      this.parser = new Loader._A(var1);
      ...
      var3.addParameter(".ssh_banner", "CobaltStrike_4.4 I paid for threat intel and all I got was this default IOC");
