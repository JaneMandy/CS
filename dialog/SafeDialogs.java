...
public class SafeDialogs {
   ...
   public static void askYesNoBoth(final String var0, final String var1, final SafeDialogCallback var2) {
      CommonUtils.runSafe(new Runnable() {
         public void run() {
            int var1x = JOptionPane.showConfirmDialog((Component)null, var0, var1, 0);
            if (var1x != 0 && var1x != 0) {
               SafeDialogs.B(var2, "no");
            } else {
               SafeDialogs.B(var2, "yes");
            }
   ...
   private static void B(final SafeDialogCallback var0, final String var1) {
   ...
   public static void chooseColor(final String var0, final Color var1, final SafeDialogCallback var2) {
      CommonUtils.runSafe(new Runnable() {
         public void run() {
            ...
            if (var1x != null) {
               SafeDialogs.B(var2, DialogUtils.encodeColor(var1x));
            }
         ...
         public void run() {
            ...
            if (var1x.showOpenDialog((Component)null) == 0) {
               if (var3) {
                  ...
                  SafeDialogs.B(var5, var2x.toString());
               } else {
