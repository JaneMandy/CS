...
public class DialogManager {
   ...
   public DialogManager.DialogRow beacon_disabled(String var1, String var2, AggressorClient var3) {
      DialogManager.DialogRow var4 = this.beacon(var1, var2, var3);
      var4.get(2).setEnabled(false);
      return var4;
   }

   public DialogManager.DialogRow beacon(final String var1, String var2, final AggressorClient var3) {
   ...
   public DialogManager.DialogRow interfaces(String var1, String var2, TeamQueue var3, DataManager var4) {
      List var5 = DataUtils.getInterfaceList(var4);
      DialogManager.DialogRow var6 = this.combobox(var1, var2, CommonUtils.toArray((Collection)var5));
      JButton var7 = new JButton("Add");
      var7.addActionListener(new DialogManager._A((JComboBox)var6.c[1], var3, var4));
      var6.last(var7);
      return var6;
   }

   public DialogManager.DialogRow exploits(String var1, String var2, AggressorClient var3) {
      List var4 = DataUtils.getBeaconExploits(var3.getData()).exploits();
      DialogManager.DialogRow var5 = this.combobox(var1, var2, CommonUtils.toArray((Collection)var4));
      return var5;
   }

   public DialogManager.DialogRow krbtgt(String var1, String var2, final AggressorClient var3) {
      DialogManager.DialogRow var4 = this.text(var1, var2);
   ...
   public DialogManager.DialogRow label(String var1) {
      DialogManager.DialogRow var2 = new DialogManager.DialogRow(new JPanel(), new JLabel(var1), new JPanel());
      this.rows.add(var2);
      if (this.group != null) {
         this.group.add(var2);
      }
   ...
   public DialogManager.DialogRow combobox(final String var1, String var2, Object[] var3) {
      new JLabel(var2);
      ...
      DialogManager.DialogRow var6 = new DialogManager.DialogRow(new JLabel(var2), var5, new JPanel());
      this.rows.add(var6);
      if (this.group != null) {
         this.group.add(var6);
      }
   ...
   public DialogManager.DialogRow attack(String var1, String var2) {
   ...
   public DialogManager.DialogRow site(String var1, String var2, final TeamQueue var3, final DataManager var4) {
      DialogManager.DialogRow var5 = this.text(var1, var2);
   ...
   public DialogManager.DialogRow sc_listener_all(String var1, String var2, final AggressorClient var3) {
      DialogManager.DialogRow var4 = this.text(var1, var2);
      final JTextField var5 = (JTextField)var4.c[1];
   ...
   public DialogManager.DialogRow sc_listener_stagers(String var1, String var2, final AggressorClient var3) {
      DialogManager.DialogRow var4 = this.text(var1, var2);
      final JTextField var5 = (JTextField)var4.c[1];
      var5.setEditable(false);
      JButton var6 = new JButton("...");
   ...
   public DialogManager.DialogRow proxyserver(String var1, String var2, final AggressorClient var3) {
      DialogManager.DialogRow var4 = this.text(var1, var2);
      final JTextField var5 = (JTextField)var4.c[1];
      JButton var6 = new JButton("...");
      var6.addActionListener(new ActionListener() {
   ...
   public DialogManager.DialogRow mailserver(String var1, String var2) {
      DialogManager.DialogRow var3 = this.text(var1, var2);
   ...
   public DialogManager.DialogRow file(String var1, String var2) {
      DialogManager.DialogRow var3 = this.text(var1, var2);
      final JTextField var4 = (JTextField)var3.c[1];
   ...
   public DialogManager.DialogRow font(String var1, String var2) {
      DialogManager.DialogRow var3 = this.text(var1, var2);
   ...
   public DialogManager.DialogRow file_import(final String var1, String var2, ATable var3, final GenericTableModel var4) {
      DialogManager.DialogRow var5 = this.file("_" + var1, var2);
      final JTextField var6 = (JTextField)var5.c[1];
   ...
   public DialogManager.DialogRow text(String var1, String var2) {
      return this.text(var1, var2, 20);
   }

   public DialogManager.DialogRow text_disabled(String var1, String var2) {
      DialogManager.DialogRow var3 = this.text(var1, var2, 20);
   ...
   public DialogManager.DialogRow text(final String var1, String var2, int var3) {
      ...
      DialogManager.DialogRow var5 = new DialogManager.DialogRow(new JLabel(var2), var4, new JPanel());
      this.rows.add(var5);
      if (this.group != null) {
         this.group.add(var5);
      }
   ...
   public DialogManager.DialogRow list_file(String var1, String var2) {
      return this.list(var1, var2, "file", 64);
   }

   public DialogManager.DialogRow list_text(String var1, String var2) {
      return this.list(var1, var2, "text", 160);
   }

   public DialogManager.DialogRow list_csv(final String var1, String var2, final String var3, final String var4, int var5) {
            ...
            SafeDialogs.ask(var3, var4, new SafeDialogCallback() {
               public void dialogResult(String var1x) {
                  ...
                  for(int var4x = 0; var4x < var5.length; ++var4x) {
                     if (var5[var4x].trim().length() > 0) {
                        var2.add(var5[var4x].trim());
                     }
                  }
      ...
      DialogManager.DialogRow var11 = new DialogManager.DialogRow(new JLabel(var2), var7, DialogUtils.stack(var10, var9, var12));
      this.rows.add(var11);
      if (this.group != null) {
   ...
   private Object A(String var1, Object var2) {
   ...
   public DialogManager.DialogRow list(final String var1, String var2, String var3, int var4) {
         ...
         if (!"".equals(var7)) {
            if ("connection.profiles".equals(var1)) {
               ...
               for(int var13 = 0; var13 < var12; ++var13) {
                  ...
                  String var15 = Prefs.getPreferences().getString("connection.profiles." + var14 + ".alias", "");
                  var9[var10] = var14 + " (" + var15 + ")";
                  ++var10;
               }

               var5.setListData(var9);
            } else {
         ...
         public void dialogAction(ActionEvent var1x, Map var2) {
            if (var5.getModel().getSize() == 0) {
               ...
               for(int var4 = 0; var4 < var5.getModel().getSize(); ++var4) {
                  var3.add(DialogManager.this.A(var1, var5.getModel().getElementAt(var4)));
               }
      ...
      JButton var16 = new JButton(DialogUtils.getIcon("resources/cc/black/png/sq_minus_icon&16.png"));
      var16.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1x) {
            ...
            for(int var4 = 0; var4 < var5.getModel().getSize(); ++var4) {
               ...
               for(int var6 = 0; var6 < var5.getSelectedIndices().length; ++var6) {
                  if (var4 == var5.getSelectedIndices()[var6]) {
                     var5x = true;
                  }
               }

               if (!var5x) {
                  var2.add(DialogManager.this.A(var1, var5.getModel().getElementAt(var4)));
                  var3.add(var5.getModel().getElementAt(var4));
               }
            }

            if ("connection.profiles".equals(var1)) {
               var5.setListData(CommonUtils.toArray((Collection)var3));
            } else {
      ...
      JComponent var17;
      if ("file".equals(var3)) {
         JButton var18 = new JButton(FileSystemView.getFileSystemView().getSystemIcon(new File(".")));
         ...
         var17 = DialogUtils.stack(var18, var16);
      } else {
         var17 = DialogUtils.stack((JComponent)var16);
      }

      DialogManager.DialogRow var19 = new DialogManager.DialogRow(new JLabel(var2), var6, var17);
      this.rows.add(var19);
      if (this.group != null) {
         this.group.add(var19);
      }

      return var19;
   }

   public DialogManager.DialogRow text_big(String var1, String var2) {
      return this.text_big(var1, var2, 20);
   }

   public DialogManager.DialogRow text_big(final String var1, String var2, int var3) {
      ...
      DialogManager.DialogRow var5 = new DialogManager.DialogRow(new JLabel(var2), new JScrollPane(var4), new JPanel());
      this.rows.add(var5);
      if (this.group != null) {
         this.group.add(var5);
      }
   ...
   public JComponent row() {
      if (this.rows.size() != 1) {
         ...
         DialogManager.DialogRow var1 = (DialogManager.DialogRow)this.rows.get(0);
   ...
   public JComponent layout(LinkedList var1) {
      ...
      var2.setLayout(var3);
      SequentialGroup var4 = var3.createSequentialGroup();

      for(int var5 = 0; var5 < 3; ++var5) {
         ParallelGroup var6 = var3.createParallelGroup();
         Iterator var7 = var1.iterator();

         while(var7.hasNext()) {
            DialogManager.DialogRow var8 = (DialogManager.DialogRow)var7.next();
      ...
      SequentialGroup var10 = var3.createSequentialGroup();
      Iterator var11 = var1.iterator();

      while(var11.hasNext()) {
         DialogManager.DialogRow var12 = (DialogManager.DialogRow)var11.next();
         ParallelGroup var13 = var3.createParallelGroup(Alignment.BASELINE);
   ...
   public DialogManager.DialogRow checkbox_add(String var1, String var2, String var3) {
      return this.checkbox_add(var1, var2, var3, true);
   }

   public DialogManager.DialogRow checkbox_add(String var1, String var2, String var3, boolean var4) {
      ...
      DialogManager.DialogRow var7 = new DialogManager.DialogRow(var5, var6, new JPanel());
      this.rows.add(var7);
      if (this.group != null) {
         this.group.add(var7);
      }
   ...
   private static class _A implements ActionListener, Callback {
      ...
      protected DataManager ħ;

      public _A(JComboBox var1, TeamQueue var2, DataManager var3) {
         this.ĥ = var1;
         this.Ħ = var2;
         this.ħ = var3;
      }
      ...
      public void actionPerformed(ActionEvent var1) {
         InterfaceDialog var2 = new InterfaceDialog(this.Ħ, this.ħ);
         var2.notify(this);
         var2.show();
      }
