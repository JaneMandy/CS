...
public class BeaconRemoteExecMethods {
   ...
   public BeaconRemoteExecMethods.RemoteExecMethod getRemoteExecMethod(String var1) {
      synchronized(this) {
         return (BeaconRemoteExecMethods.RemoteExecMethod)this.exploits.get(var1);
      }
   }

   public void register(String var1, String var2, BeaconRemoteExecMethods.RemoteExecMethod var3) {
