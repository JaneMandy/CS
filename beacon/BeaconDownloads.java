...
public class BeaconDownloads {
   ...
   public void start(String var1, int var2, String var3, String var4, long var5) {
      try {
         ...
         BeaconDownloads.BeaconDownload var11 = new BeaconDownloads.BeaconDownload(var9, var8, var1, var2);
         var11.flen = var5;
         var11.rpath = var10;
   ...
   protected BeaconDownloads.BeaconDownload find(String var1, int var2) {
      synchronized(this) {
         Iterator var4 = this.downloads.iterator();
   ...
   public void write(String var1, int var2, byte[] var3) {
      synchronized(this) {
         try {
            BeaconDownloads.BeaconDownload var5 = this.find(var1, var2);
   ...
   public boolean isComplete(String var1, int var2) {
      synchronized(this) {
         BeaconDownloads.BeaconDownload var4 = this.find(var1, var2);
   ...
   public String getName(String var1, int var2) {
      BeaconDownloads.BeaconDownload var3 = this.find(var1, var2);
