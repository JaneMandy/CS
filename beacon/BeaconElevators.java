...
public class BeaconElevators {
   ...
   public BeaconElevators.Elevator getCommandElevator(String var1) {
      synchronized(this) {
         return (BeaconElevators.Elevator)this.exploits.get(var1);
      }
   }

   public void register(String var1, String var2, BeaconElevators.Elevator var3) {
