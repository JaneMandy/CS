...
public class BeaconParts {
   ...
   public void start(String var1, int var2) {
      BeaconParts.Part var3 = new BeaconParts.Part();
      var3.length = var2;
      if (var2 > 0) {
         synchronized(this) {
   ...
   public boolean isReady(String var1) {
      BeaconParts.Part var2 = null;
      synchronized(this) {
         var2 = (BeaconParts.Part)this.parts.get(var1);
      }
   ...
   public void put(String var1, byte[] var2) {
      BeaconParts.Part var3 = null;
      synchronized(this) {
         var3 = (BeaconParts.Part)this.parts.get(var1);
      }
