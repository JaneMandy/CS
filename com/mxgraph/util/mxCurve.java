...
public class mxCurve {
   ...
   protected double minXBounds = 1.0E7D;
   protected double maxXBounds = 0.0D;
   protected double minYBounds = 1.0E7D;
   protected double maxYBounds = 0.0D;
   ...
   public mxLine getCurveParallel(String var1, double var2) {
      ...
      if (var4 != null && var4.length > 0 && var5 != null && var2 >= 0.0D && var2 <= 1.0D) {
         if (var4.length == 1) {
            mxPoint var18 = var4[0];
            return new mxLine(new mxPoint(var18.getX(), var18.getY()), new mxPoint(1.0D, 0.0D));
         } else {
         ...
         return new mxLine(new mxPoint(0.0D, 0.0D), new mxPoint(1.0D, 0.0D));
      }
   }
   ...
   public mxPoint[] getCurveSection(String var1, double var2, double var4) {
      ...
      if (var6 != null && var6.length > 0 && var7 != null && var2 >= 0.0D && var2 <= 1.0D && var4 >= 0.0D && var4 <= 1.0D) {
         if (var6.length == 1) {
   ...
   protected void createCoreCurve() {
      ...
      if (this.guidePoints != null && !this.guidePoints.isEmpty()) {
         ...
         this.minXBounds = this.minYBounds = 1.0E7D;
         this.maxXBounds = this.maxYBounds = 0.0D;
         mxSpline var44 = new mxSpline(this.guidePoints);
         double var2 = var44.getLength();
         if (!Double.isNaN(var2) && var44.checkValues() && !(var2 < 1.0D)) {
            mxSpline1D var4 = var44.getSplineX();
            mxSpline1D var5 = var44.getSplineY();
            double var6 = 12.0D / var2;
            double var8 = 1.0D / var2;
            double var10 = var6;
            double var12 = 0.15D;
            double var14 = 0.3D;
            double var16 = (var14 + var12) / 2.0D;
            double var18 = -1.0D;
            double var20 = -1.0D;
            double var22 = -1.0D;
            double var24 = -1.0D;
            ...
            mxPoint var47;
            for(double var31 = 0.0D; var31 <= 1.5D; var31 += var10) {
               if (var31 > 1.0D) {
                  var31 = 1.0001D;
               ...
               if (var18 != -1.0D && var30 && var31 != 1.0001D) {
   ...
   protected void createLabelCurve() {
      ...
      for(int var4 = 1; var4 < var1.length; ++var4) {
         ...
         double var19 = (var8.getX() + var7.getX()) / 2.0D;
         double var21 = (var8.getY() + var7.getY()) / 2.0D;
         if (var4 == 1) {
