...
public class mxCurveLabelShape implements mxITextShape {
   ...
   public mxRectangle updateLabelBounds(String var1, Map var2) {
      ...
      for(int var7 = 0; var7 < var1.length(); ++var7) {
         ...
         if (this.labelGlyphs[var7] == null) {
            this.labelGlyphs[var7] = new mxCurveLabelShape.LabelGlyphCache();
         }
      ...
      if (var10 == null) {
         mxLine var13 = this.curve.getCurveParallel(mxCurve.LABEL_CURVE, 0.5D);
         var10 = new mxRectangle(var13.getX(), var13.getY(), 1.0D, 1.0D);
      }
   ...
   protected void calculationLabelPosition(Map var1, String var2) {
      ...
      this.labelPosition.startBuffer = Math.max(this.labelPosition.startBuffer, this.labelPosition.startBuffer + var5 / 2.0D - this.labelSize / 2.0D);
      this.labelPosition.endBuffer = Math.max(this.labelPosition.endBuffer, this.labelPosition.endBuffer + var5 / 2.0D - this.labelSize / 2.0D);
   }
   ...
   public class LabelPosition {
      ...
      public LabelPosition() {
         ...
         this.defaultInterGlyphSpace = 0.0D;
      }
   }
