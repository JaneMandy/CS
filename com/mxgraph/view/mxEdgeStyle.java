      ...
      public void apply(mxCellState var1, mxCellState var2, mxCellState var3, List var4, List var5) {
         if (var2 != null) {
            ...
            if (var8 != null && !(var8.getX() < var2.getX()) && !(var8.getX() > var2.getX() + var2.getWidth())) {
               ...
               var13 = var2.getY() - 2.0D * var11;
            } else if (var19.equals("south")) {
               var13 = var2.getY() + var2.getHeight() + 2.0D * var11;
            } else if (var19.equals("east")) {
               var9 = var2.getX() - 2.0D * var15;
            } else {
               var9 = var2.getX() + var2.getWidth() + 2.0D * var15;
            }
   ...
   public static mxEdgeStyle.mxEdgeStyleFunction SideToSide = new mxEdgeStyle.mxEdgeStyleFunction() {
      public void apply(mxCellState var1, mxCellState var2, mxCellState var3, List var4, List var5) {
         ...
         if (var2 != null && var3 != null) {
            ...
            double var14 = var7 != null ? var7.getX() : var12 + (var10 - var12) / 2.0D;
            double var16 = var6.getRoutingCenterY(var2);
            ...
            if (var5.size() == 1) {
               if (var7 != null) {
                  ...
                  var5.add(new mxPoint(var14, var20 + (var22 - var20) / 2.0D));
               }
            }
         }
   ...
   public static mxEdgeStyle.mxEdgeStyleFunction TopToBottom = new mxEdgeStyle.mxEdgeStyleFunction() {
      public void apply(mxCellState var1, mxCellState var2, mxCellState var3, List var4, List var5) {
         ...
         if (var2 != null && var3 != null) {
            ...
            double var16 = var7 != null ? var7.getY() : var12 + (var10 - var12) / 2.0D;
            if (!var3.contains(var14, var16) && !var2.contains(var14, var16)) {
               var5.add(new mxPoint(var14, var16));
            }
            ...
            if (var5.size() == 1) {
               if (var7 != null) {
                  ...
                  var5.add(new mxPoint(var18 + (var20 - var18) / 2.0D, var16));
               }
            }
         }
