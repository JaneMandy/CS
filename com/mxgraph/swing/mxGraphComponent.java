...
public class mxGraphComponent extends JScrollPane implements Printable {
   ...
   protected mxPoint getPageTranslate(double var1) {
      ...
      double var9 = Math.max(0.0D, (var5 - (double)var3.width) / 2.0D);
      double var11 = Math.max(0.0D, (var7 - (double)var3.height) / 2.0D);
   ...
   public void zoomOut() {
      this.zoom(1.0D / this.zoomFactor);
   }

   public void zoom(double var1) {
      mxGraphView var3 = this.graph.getView();
      double var4 = (double)((int)(var3.getScale() * 100.0D * var1)) / 100.0D;
      if (var4 != var3.getScale() && var4 > 0.01D) {
   ...
   public void zoomActual() {
      mxPoint var1 = this.pageVisible && this.centerPage ? this.getPageTranslate(1.0D) : new mxPoint();
      this.graph.getView().scaleAndTranslate(1.0D, var1.getX(), var1.getY());
   ...
   public void zoom(final boolean var1, final boolean var2) {
      if (this.pageVisible && !this.zooming) {
         ...
         try {
            ...
            double var16 = (double)((int)(Math.min(var12, var14) * 20.0D)) / 20.0D;
            if (var16 > 0.0D) {
   ...
   protected void maintainScrollBar(boolean var1, double var2, boolean var4) {
      ...
      if (var5 != null) {
         ...
         int var7 = (int)Math.round((double)var6.getValue() * var2) + (int)Math.round(var4 ? (double)var6.getExtent() * (var2 - 1.0D) / 2.0D : 0.0D);
         var6.setValue(var7);
      }
   ...
   public Rectangle getFoldingIconBounds(mxCellState var1, ImageIcon var2) {
      ...
      int var7 = (int)Math.round(var1.getX() + 4.0D * var5);
      int var8 = (int)Math.round(var1.getY() + 4.0D * var5);
      int var9 = (int)Math.max(8.0D, (double)var2.getIconWidth() * var5);
      int var10 = (int)Math.max(8.0D, (double)var2.getIconHeight() * var5);
      if (var4) {
   ...
   public mxPoint snapScaledPoint(mxPoint var1) {
      return this.snapScaledPoint(var1, 0.0D, 0.0D);
   }
   ...
   public int print(Graphics var1, PageFormat var2, int var3) {
      ...
      mxTemporaryCellStates var9 = new mxTemporaryCellStates(var6, 1.0D / this.pageScale);

      try {
         var6.setTranslate(new mxPoint(0.0D, 0.0D));
         ...
         int var15 = (int)Math.max(Math.ceil((double)(var12.width - 5) / (double)var13), 1.0D);
         int var16 = (int)Math.max(Math.ceil((double)(var12.height - 5) / (double)var14), 1.0D);
         if (var3 < var15 * var16) {
   ...
   protected void paintGrid(Graphics var1) {
      if (this.isGridVisible()) {
         ...
         if (var21 < (double)var13) {
            int var23 = (int)Math.round(Math.ceil((double)var13 / var21) / 2.0D) * 2;
   ...
   public void checkTripleBuffer() {
      mxRectangle var1 = this.graph.getGraphBounds();
      int var2 = (int)Math.ceil(var1.getX() + var1.getWidth() + 2.0D);
      int var3 = (int)Math.ceil(var1.getY() + var1.getHeight() + 2.0D);
