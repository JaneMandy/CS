...
public class mxSharedDiagram {
   ...
   public void addDiagramChangeListener(mxSharedDiagram.mxDiagramChangeListener var1) {
   ...
   public void removeDiagramChangeListener(mxSharedDiagram.mxDiagramChangeListener var1) {
      if (this.diagramChangeListeners != null) {
   ...
   void dispatchDiagramChangeEvent(Object var1, String var2) {
      if (this.diagramChangeListeners != null) {
         ...
         while(var3.hasNext()) {
            mxSharedDiagram.mxDiagramChangeListener var4 = (mxSharedDiagram.mxDiagramChangeListener)var3.next();
