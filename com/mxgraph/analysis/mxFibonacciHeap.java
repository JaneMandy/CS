...
public class mxFibonacciHeap {
   ...
   public mxFibonacciHeap.Node getNode(Object var1, boolean var2) {
      mxFibonacciHeap.Node var3 = (mxFibonacciHeap.Node)this.nodes.get(var1);
      if (var3 == null && var2) {
         var3 = new mxFibonacciHeap.Node(var1, Double.MAX_VALUE);
   ...
   public void decreaseKey(mxFibonacciHeap.Node var1, double var2) {
      if (var2 > var1.key) {
         throw new IllegalArgumentException("decreaseKey() got larger key value");
      } else {
         var1.key = var2;
         mxFibonacciHeap.Node var4 = var1.parent;
   ...
   public void delete(mxFibonacciHeap.Node var1) {
      this.decreaseKey(var1, Double.NEGATIVE_INFINITY);
      this.removeMin();
   }

   public void insert(mxFibonacciHeap.Node var1, double var2) {
      var1.key = var2;
      if (this.min != null) {
         var1.left = this.min;
   ...
   public mxFibonacciHeap.Node removeMin() {
      mxFibonacciHeap.Node var1 = this.min;
      if (var1 != null) {
         int var2 = var1.degree;

         for(mxFibonacciHeap.Node var3 = var1.child; var2 > 0; --var2) {
            mxFibonacciHeap.Node var4 = var3.right;
   ...
   protected void cascadingCut(mxFibonacciHeap.Node var1) {
      mxFibonacciHeap.Node var2 = var1.parent;
      if (var2 != null) {
         if (!var1.mark) {
            var1.mark = true;
         } else {
   ...
   protected void consolidate() {
      ...
      mxFibonacciHeap.Node[] var2 = new mxFibonacciHeap.Node[var1];
      ...
      var3 = 0;
      mxFibonacciHeap.Node var4 = this.min;
      if (var4 != null) {
         ++var3;
      ...
      while(var3 > 0) {
         ...
         mxFibonacciHeap.Node var6;
         for(var6 = var4.right; var2[var5] != null; ++var5) {
            mxFibonacciHeap.Node var7 = var2[var5];
            if (var4.key > var7.key) {
               mxFibonacciHeap.Node var8 = var7;
               var7 = var4;
               var4 = var8;
            }
   ...
   protected void cut(mxFibonacciHeap.Node var1, mxFibonacciHeap.Node var2) {
      var1.left.right = var1.right;
      var1.right.left = var1.left;
      --var2.degree;
      if (var2.child == var1) {
   ...
   protected void link(mxFibonacciHeap.Node var1, mxFibonacciHeap.Node var2) {
      var1.left.right = var1.right;
      var1.right.left = var1.left;
      var1.parent = var2;
      if (var2.child == null) {
