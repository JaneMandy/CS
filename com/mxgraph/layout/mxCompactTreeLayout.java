...
public class mxCompactTreeLayout extends mxGraphLayout {
   ...
   public void execute(Object var1, Object var2) {
      ...
      if (var2 != null) {
         ...
         try {
            mxCompactTreeLayout.TreeNode var23 = this.dfs(var2, var1, (Set)null);
            if (var23 != null) {
               this.layout(var23);
               ...
               if (var25 != null) {
                  ...
                  if (var1 != null) {
                     ...
                     if (this.resizeParent && !this.graph.isCellCollapsed(var1)) {
                        ...
                        if (var15 != null) {
                           double var16 = var25.getWidth() + var14.getWidth() - var25.getX() + 2.0D * var24;
                           double var18 = var25.getHeight() + var14.getHeight() - var25.getY() + 2.0D * var7;
                           var15 = (mxGeometry)var15.clone();
                           if (var15.getWidth() > var16) {
                              var10 += (var15.getWidth() - var16) / 2.0D;
                           } else {
                           ...
                           if (var15.getHeight() > var18) {
                              if (this.horizontal) {
                                 var12 += (var15.getHeight() - var18) / 2.0D;
                              }
                           } else {
   ...
   protected mxCompactTreeLayout.TreeNode dfs(Object var1, Object var2, Set var3) {
      if (var3 == null) {
         var3 = new HashSet();
      }
      ...
      if (var1 != null && !((Set)var3).contains(var1) && !this.isVertexIgnored(var1)) {
         ...
         for(int var8 = 0; var8 < var7.length; ++var8) {
            ...
            if (!this.isEdgeIgnored(var9)) {
               ...
               mxCompactTreeLayout.TreeNode var11 = this.dfs(var10, var2, (Set)var3);
   ...
   protected void attachParent(mxCompactTreeLayout.TreeNode var1, double var2) {
      ...
      double var6 = (var2 - var1.width) / 2.0D - (double)this.nodeDistance;
      double var8 = var6 + var1.width + (double)(2 * this.nodeDistance) - var2;
      var1.child.offsetX = var4 + var1.height;
      var1.child.offsetY = var8;
      var1.contour.upperHead = this.createLine(var1.height, 0.0D, this.createLine(var4, var8, var1.contour.upperHead));
      var1.contour.lowerHead = this.createLine(var1.height, 0.0D, this.createLine(var4, var6, var1.contour.lowerHead));
   }

   protected void layoutLeaf(mxCompactTreeLayout.TreeNode var1) {
      double var2 = (double)(2 * this.nodeDistance);
      var1.contour.upperTail = this.createLine(var1.height + var2, 0.0D, (mxCompactTreeLayout.Polyline)null);
      var1.contour.upperHead = var1.contour.upperTail;
      var1.contour.lowerTail = this.createLine(0.0D, -var1.width - var2, (mxCompactTreeLayout.Polyline)null);
      var1.contour.lowerHead = this.createLine(var1.height + var2, 0.0D, var1.contour.lowerTail);
   }
   ...
   protected double merge(mxCompactTreeLayout.Polygon var1, mxCompactTreeLayout.Polygon var2) {
      ...
      mxCompactTreeLayout.Polyline var13;
      if (var10 != null) {
         var13 = this.bridge(var1.upperTail, 0.0D, 0.0D, var10, var3, var5);
         var1.upperTail = var13.next != null ? var2.upperTail : var13;
         var1.lowerTail = var2.lowerTail;
      } else {
         var13 = this.bridge(var2.lowerTail, var3, var5, var9, 0.0D, 0.0D);
         if (var13.next == null) {
   ...
   protected double offset(double var1, double var3, double var5, double var7, double var9, double var11) {
      ...
      if (!(var9 <= var1) && !(var1 + var5 <= 0.0D)) {
         ...
         return var13 > 0.0D ? var13 : 0.0D;
      } else {
         return 0.0D;
      }
   }

   protected mxCompactTreeLayout.Polyline bridge(mxCompactTreeLayout.Polyline var1, double var2, double var4, mxCompactTreeLayout.Polyline var6, double var7, double var9) {
      ...
      var1.next = this.createLine(0.0D, var9 + var6.dy - var13 - var4, var17);
      return var17;
   }
