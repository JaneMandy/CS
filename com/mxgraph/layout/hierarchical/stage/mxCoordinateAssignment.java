...
public class mxCoordinateAssignment implements mxHierarchicalLayoutStage {
   ...
   private void minNode(mxGraphHierarchyModel var1) {
      ...
      for(byte var27 = 1; !var2.isEmpty() && var26 <= var5; ++var26) {
         mxCoordinateAssignment.WeightedCellSorter var28 = (mxCoordinateAssignment.WeightedCellSorter)var2.getFirst();
         ...
         if (var22) {
            mxCoordinateAssignment.WeightedCellSorter var32;
            for(var30 = 0; var30 < var12.length; ++var30) {
               var31 = (mxGraphAbstractHierarchyCell)var12[var30];
               var32 = (mxCoordinateAssignment.WeightedCellSorter)var3.get(var31);
      ...
      for(var8 = 0; var8 < var6.length; ++var8) {
         ...
         while(var17 >= 0) {
            ...
            if (var18 != null) {
               ...
               if (var18.visited) {
                  var15 = (double)var19.getGeneralPurposeVariable(var1) + var19.width / 2.0D + this.intraCellSpacing + var13 + var26.width / 2.0D;
                  var17 = -1;
               } else {
         ...
         while(var21 < var6.length) {
            ...
            if (var22 != null) {
               ...
               if (var22.visited) {
                  var28 = (double)var23.getGeneralPurposeVariable(var1) - var23.width / 2.0D - this.intraCellSpacing - var27 - var26.width / 2.0D;
                  var21 = var6.length;
               } else {
   ...
   protected void rankCoordinates(int var1, mxGraph var2, mxGraphHierarchyModel var3) {
      ...
      double var5 = 0.0D;
      double var7 = this.initialX + (this.widestRankValue - this.rankWidths[var1]) / 2.0D;
      boolean var9 = false;
   ...
   protected void calculateWidestRank(mxGraph var1, mxGraphHierarchyModel var2) {
      ...
      for(int var7 = var2.maxRank; var7 >= 0; --var7) {
         ...
         double var18 = var8 / 2.0D + var5 / 2.0D + this.interRankCellSpacing;
         var5 = var8;
         ...
         while(true) {
            while(true) {
               ...
               if (var6.isVertex()) {
                  ...
                  double var9 = var16.x[0] - var16.width / 2.0D;
                  double var18 = var16.y[0] - var16.height / 2.0D;
                  if (this.orientation != 1 && this.orientation != 5) {
   ...
   protected class AreaSpatialCache extends Double {
      ...
      public int compareTo(Object var1) {
         if (var1 instanceof mxCoordinateAssignment.WeightedCellSorter) {
            if (this.weightedValue > ((mxCoordinateAssignment.WeightedCellSorter)var1).weightedValue) {
               return -1;
            } else if (this.weightedValue < ((mxCoordinateAssignment.WeightedCellSorter)var1).weightedValue) {
               return 1;
            } else {
