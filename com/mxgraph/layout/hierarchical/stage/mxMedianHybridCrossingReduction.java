...
public class mxMedianHybridCrossingReduction implements mxHierarchicalLayoutStage {
   ...
   private void medianRank(int var1, boolean var2) {
      ...
      mxMedianHybridCrossingReduction.MedianCellSorter[] var4 = new mxMedianHybridCrossingReduction.MedianCellSorter[var3];

      int var5;
      for(var5 = 0; var5 < var3; ++var5) {
         mxGraphAbstractHierarchyCell var6 = this.nestedBestRanks[var1][var5];
         var4[var5] = new mxMedianHybridCrossingReduction.MedianCellSorter();
         var4[var5].cell = var6;
      ...
      public int compareTo(Object var1) {
         if (var1 instanceof mxMedianHybridCrossingReduction.MedianCellSorter) {
            if (this.medianValue < ((mxMedianHybridCrossingReduction.MedianCellSorter)var1).medianValue) {
               return -1;
            } else if (this.medianValue > ((mxMedianHybridCrossingReduction.MedianCellSorter)var1).medianValue) {
               return 1;
            } else {
