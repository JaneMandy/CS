...
public class GlobalDataManager implements Runnable, GenericDataManager {
   ...
   public void report(DataManager var1, String var2, Object var3) {
      synchronized(this) {
         this.reports.add(new GlobalDataManager._A(var1, var2, var3));
      }
   }

   protected GlobalDataManager._A grab() {
      synchronized(this) {
         return (GlobalDataManager._A)this.reports.pollFirst();
      }
   }

   public void run() {
      long var1 = System.currentTimeMillis() + 10000L;
      GlobalDataManager._A var3 = null;
      ...
      try {
         while(true) {
            ...
            if (var3 == null) {
               ...
               this.process(var3.B, var3.A, var3.C);
               Thread.yield();
            }
         }
   ...
   private static class _A {
      ...
      public _A(DataManager var1, String var2, Object var3) {
         this.B = var1;
         this.A = var2;
         this.C = var3;
      }
