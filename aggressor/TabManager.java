...
public class TabManager extends AObject implements Callback {
   ...
   protected TabManager._A docked = null;
   ...
   public boolean activateConsole(String var1) {
      ...
      do {
         ...
         var3 = (TabManager._A)var2.next();
      } while(!var1.equals(var3.A) || !(var3.C instanceof Console));

      this.tabs.setSelectedComponent(var3.C);
      ((Console)var3.C).requestFocusInWindow();
      return true;
   }
   ...
   public void closeAllButActiveTab() {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.C != var1) {
            this.removeAppTab(var3.C, (String)null, new ActionEvent(var3.C, 0, "boo!"));
         }
      }
   ...
   public void addAppTab(String var1, JComponent var2, JLabel var3, String var4, ActionListener var5) {
      CommonUtils.Guard();
      TabManager._A var6 = new TabManager._A();
      var6.E = var1;
      var6.C = var2;
      var6.D = var5;
      var6.B = var3;
   ...
   public void popAppTab(Component var1) {
      ...
      while(var2.hasNext()) {
         final TabManager._A var3 = (TabManager._A)var2.next();
         if (var3.C == var1) {
            this.tabs.remove(var3.C);
            var2.remove();
            final JFrame var4 = new JFrame(var3.E);
            var4.setLayout(new BorderLayout());
            var4.add(var3.C, "Center");
            var4.pack();
            var3.C.validate();
            var4.addWindowListener(new WindowAdapter() {
               public void windowClosing(WindowEvent var1) {
                  if (var3.D != null) {
                     var3.D.actionPerformed(new ActionEvent(var1.getSource(), 0, "close"));
                  }
   ...
   public void dockAppTab(Component var1) {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.C == var1) {
            ...
            if (this.docked != null) {
               var4 = this.docked.C.getSize();
               if (this.docked.D != null) {
                  this.docked.D.actionPerformed(new ActionEvent(this.docked.C, 0, "close"));
               }
            }

            this.client.dock(var3.C, var4);
            this.docked = var3;
         }
      }
   ...
   public void removeAppTab(Component var1, String var2, ActionEvent var3) {
      ...
      while(true) {
         ...
         do {
            ...
            var6 = (TabManager._A)var4.next();
            var7 = var6.E != null ? var6.E.split(" ")[0] : "%a%";
         } while(var6.C != var1 && !var7.equals(var5));

         this.tabs.remove(var6.C);
         if (var6.D != null) {
            var6.D.actionPerformed(var3);
         }
   ...
   public void _addTab(final String var1, final JComponent var2, ActionListener var3, String var4) {
      ...
      var9.addMouseListener(new MouseAdapter() {
         public void A(MouseEvent var1x) {
   ...
   public void processBeacon(TabManager._A var1, BeaconEntry var2) {
      String var3 = var2.title() + "   ";
      if (!var1.E.equals(var3) && var1.C instanceof Console) {
         var1.B.setText(var3);
         var1.E = var3;
      }
      ...
      if ("".equals(var4)) {
         var1.B.setIcon((Icon)null);
      } else {
         var1.B.setIcon(new SolidIcon(this.colors.getBackColor(var4), 12, 12));
      }
   ...
   public void result(String var1, final Object var2) {
      CommonUtils.runSafe(new Runnable() {
         public void run() {
            ...
            while(var1.hasNext()) {
               TabManager._A var2x = (TabManager._A)var1.next();
               if (!"".equals(var2x.A)) {
                  BeaconEntry var3 = DataUtils.getBeaconFromResult(var2, var2x.A);
                  if (var3 != null) {
