...
public class Processes extends AObject implements Callback, TablePopup, TableModelListener {
   ...
   Icon Ñ = DialogUtils.getIcon("resources/cc/black/png/app_window&16.png");
   Icon Ò = DialogUtils.getIcon("resources/cc/black/png/app_window_shell_icon&16.png");
   Icon Ö = DialogUtils.getIcon("resources/cc/black/png/globe_3_icon&16.png");
   Icon Ï = DialogUtils.getIcon("resources/cc/black/png/print_icon&16.png");
   Icon Î = DialogUtils.getIcon("resources/cc/black/png/vault_icon&16.png");
   Icon Í = DialogUtils.getIcon("resources/cc/black/png/key_icon&16.png");
   Icon Ô = DialogUtils.getIcon("resources/cc/black/png/browser_icon&16.png");
   Icon Õ = DialogUtils.getIcon("resources/cc/black/png/coffe_cup_icon&16.png");
   Icon Ð = DialogUtils.getIcon("resources/cc/black/png/net_comp_icon&16.png");
   Icon Ó = DialogUtils.getIcon("resources/cc/black/png/cogs_icon&16.png");
   ...
   public void doMouseClicked(MouseEvent var1) {
      ...
      if (var2 != null) {
         ...
         if (var3 != null) {
            Processes._A var4 = (Processes._A)var3.getUserObject();
            if (var4 != null) {
               this.model.activateRow(this.table, var4.G);
            }
         }
      }
   ...
   public TreeCellRenderer getNewRenderer() {
      DefaultTreeCellRenderer var1 = new DefaultTreeCellRenderer() {
         public Component getTreeCellRendererComponent(JTree var1, Object var2, boolean var3, boolean var4, boolean var5, int var6, boolean var7) {
            ...
            Processes._A var9 = (Processes._A)var8.getUserObject();
            if (var9 == null) {
               super.getTreeCellRendererComponent(var1, var2, var3, var4, var5, var6, false);
               return this;
            } else {
               var3 = Processes.this.model.isSelected(Processes.this.table, var9.G);
               super.getTreeCellRendererComponent(var1, var2, var3, var4, var5, var6, false);
               this.setIcon(var9.C);
               if (var3) {
   ...
   public Processes._A getNode(int var1, String var2, String var3, String var4) {
      Processes._A var5 = new Processes._A();
      var5.G = var1;
      var5.B = var2;
      var5.F = var3;
      var5.E = var2.equals(this.mypid);
      var5.A = var4.endsWith(" *");
      var5.D = var4.length() > 0;
