...
public class Connect implements DialogListener, Callback, ArmitageTrustListener {
   ...
   private boolean A(Map var1) {
      ...
      if (var6.length() > 0) {
         Prefs.getPreferences().set("connection.last", this.ċ != null ? this.ċ : "New Profile");
   ...
   public void result(String var1, Object var2) {
      if ("aggressor.authenticate".equals(var1)) {
         ...
         CommonUtils.runSafe(new Runnable() {
            public void run() {
               Connect.this.window.addButton(Connect.this.alias, var4, Connect.this.ĉ == null ? Connect.this.alias : Connect.this.ĉ);
               var4.showTime();
            }
         });
      }
