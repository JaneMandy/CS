...
public final class DataUtils {
   ...
   public static String getPostExPipeName(DataManager var0, String var1) {
      return getProfile(var0).getPostExPipeName(var1);
   }
   ...
   public static String getDefaultPipeName(Profile var0, byte[] var1, String var2) {
      ...
      return "\\\\" + var2 + "\\pipe\\" + getPipeName(var3, var1);
   }

   public static String getPipeName(String var0, byte[] var1) {
      if (!CommonUtils.isin("#", var0)) {
         return var0;
      } else {
         String var2;
         for(var2 = CommonUtils.toHex(CommonUtils.MD5(var1)); var2.length() < var0.length(); var2 = var2 + var2) {
         }

         return CommonUtils.replaceHashes(var0, var2);
      }
   }
   ...
   public static boolean hostStage(DataManager var0) {
   ...
   public static List getBeaconChain(DataManager var0, String var1) {
      return A(var0, var1, new LinkedList());
   }

   private static List A(DataManager var0, String var1, List var2) {
      BeaconEntry var3 = getBeacon(var0, var1);
      if (var3 != null) {
         var2.add(var3.getInternal());
      }

      return var3.isLinked() ? A(var0, var3.getParentId(), var2) : var2;
   }
   ...
   public static List getBeaconModelFromResult(Object var0) {
      ...
      for(Iterator var3 = var2.values().iterator(); var3.hasNext(); var1.add(var5)) {
         ...
         var5 = var4.toMap();
         if (var4.isEmpty()) {
            var5.put("image", DialogUtils.TargetVisualizationSmall("unknown", 0.0D, false, false));
         } else {
