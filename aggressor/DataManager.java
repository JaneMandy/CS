...
public class DataManager implements Callback, GenericDataManager {
   ...
   private LinkedList B(String var1) {
      synchronized(this) {
   ...
   public LinkedList getTranscriptSafe(String var1) {
      synchronized(this) {
         return new LinkedList(this.B(var1));
      }
   }
   ...
   public void result(String var1, Object var2) {
      synchronized(this) {
         ...
         } else if (!(var2 instanceof Directive)) {
            if (var2 instanceof PlaybackStatus) {
