...
public class ConnectDialog extends Starter2 {
   ...
   public void show() {
      ...
      this.options.addPage("New Profile", (Icon)null, "This is the connect dialog. You should use it to connect to a Cobalt Strike (Aggressor) team server.", (new Connect(this.window)).getContent(var3, "neo", "password", "127.0.0.1", "50050", "neo@127.0.0.1"));
