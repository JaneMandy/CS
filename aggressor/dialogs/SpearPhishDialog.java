         ...
         if (!this.checkContactsReverse(this.contacts)) {
            if ("".equals(this.template)) {
               ...
               try {
                  ...
                  new Eater(new ByteArrayInputStream(CommonUtils.toBytes(var3)));
               } catch (Exception var5) {
                  String var4 = "Trouble processing phishing email template (" + this.template + "):";
                  MudgeSanity.logException(var4 + " " + var5.getMessage(), var5, false);
