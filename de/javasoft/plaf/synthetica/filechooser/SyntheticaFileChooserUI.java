...
public class SyntheticaFileChooserUI extends BasicFileChooserUI implements ActionListener {
   ...
   private SyntheticaFileChooserUI.FilePane filePane;
   ...
   public void installComponents(final JFileChooser var1) {
      ...
      final SyntheticaFileChooserUI.DirectoryComboBoxModel var5 = new SyntheticaFileChooserUI.DirectoryComboBoxModel();
      ...
      this.directoryComboBox.setRenderer(new DefaultListCellRenderer() {
         SyntheticaFileChooserUI.IndentIcon ii = SyntheticaFileChooserUI.this.new IndentIcon((SyntheticaFileChooserUI.IndentIcon)null);
      ...
      if (!this.directoryChooser) {
         ...
         SyntheticaFileChooserUI.FilterComboBoxModel var19 = new SyntheticaFileChooserUI.FilterComboBoxModel();
      ...
      for(var20 = 0; var20 < var21; ++var20) {
         var26 = var22[var20];
         Constraints var23 = var24.getConstraints(var26);
   ...
   protected SyntheticaFileChooserUI.FilePane createFilePane() {
      return new SyntheticaFileChooserUI.FilePane();
   }
                     ...
                     public void run() {
                        if (SyntheticaFileChooserUI.this.filePane.view == 2 && var8) {
                           ...
                           while(var3x.hasNext()) {
                              ...
                              ((SyntheticaFileChooserUI.FilePane.FileNode)var4.getLastPathComponent()).prepareForUpdateChildren();
   ...
   private synchronized void fillFileBuffer(Collection var1) {
      ...
      if (this.filePane.view == 2) {
         ...
         for(int var3 = 0; var3 < var4; ++var3) {
            ...
            SyntheticaFileChooserUI.FilePane.FileNode var6 = (SyntheticaFileChooserUI.FilePane.FileNode)var2.getLastPathComponent();
            var1.add(var6.getFile());
         }
      } else {
         ListSelectionModel var7 = this.filePane.list.getSelectionModel();
         SyntheticaFileChooserUI.FilePane.DetailsTableSortModel var8 = this.filePane.detailsTableSortModel;
   ...
   private void doSelectedFileChanged(PropertyChangeEvent var1) {
      ...
      if (var2 != null) {
         ((SyntheticaFileChooserUI.FilePane.DetailsTableModel)this.filePane.detailsTableSortModel.model).doFileSelection();
   ...
   private void doDirectoryChanged(PropertyChangeEvent var1) {
      ...
      ((SyntheticaFileChooserUI.DirectoryComboBoxModel)this.directoryComboBox.getModel()).addItem(var3);
      boolean var4 = false;
   ...
   public void rescanCurrentDirectory(JFileChooser var1) {
      ...
      if (this.treePanelEnabled) {
         ...
         ((SyntheticaFileChooserUI.FilePane.FileNode)var3.getLastPathComponent()).prepareForUpdateChildren();
   ...
   public class FilePane extends JPanel implements PropertyChangeListener {
      ...
      private JTree tree;
      private SyntheticaFileChooserUI.FilePane.DetailsTableSortModel detailsTableSortModel;
      ...
      protected JPanel createListPanel() {
         ...
         this.list.setCellRenderer(new SyntheticaFileChooserUI.FilePane.ListRenderer(this.list.getCellRenderer()));
         ...
         this.list.addMouseListener(new SyntheticaFileChooserUI.FilePane.FilePaneMouseListener(this.list));
      ...
      protected JPanel createTablePanel() {
         ...
         this.detailsTableSortModel = new SyntheticaFileChooserUI.FilePane.DetailsTableSortModel(new SyntheticaFileChooserUI.FilePane.DetailsTableModel(var2));
         ...
         this.table.getTableHeader().setDefaultRenderer(new SyntheticaFileChooserUI.FilePane.TableHeaderRenderer(this.table));
         this.table.getTableHeader().addMouseListener(new SyntheticaFileChooserUI.FilePane.FilePaneMouseListener(this.table));
         ...
         SyntheticaFileChooserUI.FilePane.DetailsTableCellRenderer var14 = new SyntheticaFileChooserUI.FilePane.DetailsTableCellRenderer(var2);
         ...
         this.table.addMouseListener(new SyntheticaFileChooserUI.FilePane.FilePaneMouseListener(this.table));
         ...
         if (UIManager.get("Table.scrollPaneCornerComponent") == null) {
            var15.setCorner("UPPER_TRAILING_CORNER", new SyntheticaFileChooserUI.TableHeaderCorner(this.table));
         }
      ...
      protected JPanel createTreePanel() {
         ...
         SyntheticaFileChooserUI.FilePane.FileNode var3 = new SyntheticaFileChooserUI.FilePane.FileNode(var2.getFileSystemView().getRoots()[0]);
         this.tree.setModel(new DefaultTreeModel(var3));
         this.tree.setCellRenderer(new SyntheticaFileChooserUI.FilePane.TreeRenderer((SyntheticaFileChooserUI.FilePane.TreeRenderer)null));
         this.tree.setCellEditor(new DefaultTreeCellEditor(this.tree, (DefaultTreeCellRenderer)this.tree.getCellRenderer(), new SyntheticaFileChooserUI.FilePane.FileCellEditor(new JTextField())));
         this.tree.getCellEditor().addCellEditorListener(new CellEditorListener() {
            public void editingStopped(ChangeEvent var1) {
               SyntheticaFileChooserUI.FilePane.FileCellEditor var2 = (SyntheticaFileChooserUI.FilePane.FileCellEditor)var1.getSource();
               String var3 = var2.getDelegateValue();
               FilePane.this.editTextField.setText(var3);
               FilePane.this.editFile = ((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile();
               File var4 = FilePane.this.applyEditFileName();
               TreePath var5 = SyntheticaFileChooserUI.this.filePane.getPath(var4);
               ((SyntheticaFileChooserUI.FilePane.FileNode)var5.getLastPathComponent()).prepareForUpdateChildren();
         ...
         this.tree.getSelectionModel().addTreeSelectionListener(new TreeSelectionListener() {
            public void valueChanged(TreeSelectionEvent var1) {
               if (FilePane.this.tree.getSelectionPath() != null && FilePane.this.view == 2) {
                  final File var2x = ((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile().getAbsoluteFile();
                  File var3 = var2.getCurrentDirectory();
         ...
         this.tree.addMouseListener(new SyntheticaFileChooserUI.FilePane.FilePaneMouseListener(this.list));
      ...
      private TreePath getPath(File var1) {
         SyntheticaFileChooserUI.FilePane.FileNode var2 = (SyntheticaFileChooserUI.FilePane.FileNode)this.tree.getModel().getRoot();
         if (!var2.getFile().equals(var1) && var1 != null) {
            ...
            SyntheticaFileChooserUI.FilePane.FileNode var4 = (SyntheticaFileChooserUI.FilePane.FileNode)var3.getLastPathComponent();
            Enumeration var5 = var4.children();

            SyntheticaFileChooserUI.FilePane.FileNode var6;
            do {
               if (!var5.hasMoreElements()) {
                  return var3;
               }

               var6 = (SyntheticaFileChooserUI.FilePane.FileNode)var5.nextElement();
      ...
      private class DetailsTableCellRenderer extends DefaultTableCellRenderer {
         ...
         public Component getTableCellRendererComponent(JTable var1, Object var2, boolean var3, boolean var4, int var5, int var6) {
            ...
            Object var13 = var7.getBorder() instanceof SyntheticaFileChooserUI.FilePane.PaddingBorder ? ((SyntheticaFileChooserUI.FilePane.PaddingBorder)this.getBorder()).getOutsideBorder() : var7.getBorder();
      ...
      private class DetailsTableSortModel extends AbstractTableModel implements TableModelListener {
         TableModel model;
         SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row[] rows;
         ...
         public void reinit() {
            this.rows = new SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row[this.model.getRowCount()];

            for(int var1 = 0; var1 < this.rows.length; this.rows[var1].index = var1++) {
               this.rows[var1] = new SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row((SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row)null);
            }
         ...
         public void tableChanged(TableModelEvent var1) {
            this.reinit();
            File var2 = ((SyntheticaFileChooserUI.FilePane.DetailsTableModel)this.model).newAddedEntry;
            if (var2 != null && FilePane.this.newCreatedFile) {
               ...
               ((SyntheticaFileChooserUI.FilePane.DetailsTableModel)this.model).newAddedEntry = null;
         ...
         private class Row implements Comparable {
            ...
            public int compareTo(Object var1) {
               if (!SyntheticaFileChooserUI.this.sortEnabled) {
                  ...
                  File var3 = (File)DetailsTableSortModel.this.model.getValueAt(((SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row)var1).index, 0);
            ...
            // $FF: synthetic method
            Row(SyntheticaFileChooserUI.FilePane.DetailsTableSortModel.Row var2) {
               this();
            }
         }
      }
      ...
      private class FileCellEditor extends DefaultCellEditor {
         ...
         public Object getCellEditorValue() {
            return ((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile();
         }
      ...
      public class TableHeaderRenderer implements TableCellRenderer {
         ...
         public Component getTableCellRendererComponent(JTable var1, Object var2, boolean var3, boolean var4, int var5, int var6) {
            ...
            Object var8 = var7.getBorder() instanceof SyntheticaFileChooserUI.FilePane.IconBorder ? ((SyntheticaFileChooserUI.FilePane.IconBorder)FilePane.this.getBorder()).getOutsideBorder() : var7.getBorder();
      ...
      private class TreeRenderer extends DefaultTreeCellRenderer {
         ...
         public Component getTreeCellRendererComponent(JTree var1, Object var2, boolean var3, boolean var4, boolean var5, int var6, boolean var7) {
            ...
            File var8 = ((SyntheticaFileChooserUI.FilePane.FileNode)var2).getFile();
         ...
         public Icon getLeafIcon() {
            return FilePane.this.tree.getSelectionPath() == null ? super.getLeafIcon() : this.getIcon(((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile());
         }

         public Icon getOpenIcon() {
            return FilePane.this.tree.getSelectionPath() == null ? super.getOpenIcon() : this.getIcon(((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile());
         }

         public Icon getClosedIcon() {
            return FilePane.this.tree.getSelectionPath() == null ? super.getClosedIcon() : this.getIcon(((SyntheticaFileChooserUI.FilePane.FileNode)FilePane.this.tree.getSelectionPath().getLastPathComponent()).getFile());
         }
         ...
         // $FF: synthetic method
         TreeRenderer(SyntheticaFileChooserUI.FilePane.TreeRenderer var2) {
            this();
         }
      }
   }
   ...
   protected class FileSelectHandler implements KeyListener {
      ...
      private int getNextFileIndex(JComponent var1, String var2, int var3, Bias var4) {
         int var5 = -1;
   ...
   private class IndentIcon implements Icon {
      ...
      // $FF: synthetic method
      IndentIcon(SyntheticaFileChooserUI.IndentIcon var2) {
         this();
      }
   }
