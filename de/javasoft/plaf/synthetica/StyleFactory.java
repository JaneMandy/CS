...
public class StyleFactory extends SynthStyleFactory {
      ...
      if (var2 == Region.ARROW_BUTTON) {
         ...
         if (var2 == Region.BUTTON) {
            ...
            if (var2 == Region.DESKTOP_PANE) {
               ...
               if ("ComboPopup.popup".equals(var5) && UIManager.get("Synthetica.comboPopup.insets") != null && !(var1.getBorder() instanceof StyleFactory.SyntheticaComboPopupBorder) && SyntheticaLookAndFeel.findComponent((Class)JScrollPane.class, var1) != null) {
                  var1.setBorder(new StyleFactory.SyntheticaComboPopupBorder((StyleFactory.SyntheticaComboPopupBorder)null));
   ...
   private void installCellRendererHoverListener(JComponent var1) {
      ...
      if (this.cellRendererHoverListener == null) {
         this.cellRendererHoverListener = new StyleFactory.CellRendererHoverListener((StyleFactory.CellRendererHoverListener)null);
      }
   ...
   private void installFocusListener(Component var1) {
      if (var1.isEnabled()) {
         ...
         var1.addFocusListener(new StyleFactory.RepaintFocusListener((StyleFactory.RepaintFocusListener)null));
      }
   }
   ...
   private void installTextComponentPropertyChangeListener(Component var1) {
      if (!this.eventListenerExists(var1.getPropertyChangeListeners())) {
         this.componentPropertyStore.storeComponentProperty(var1, "SYCP_PROPERTY_CHANGE_LISTENERS");
         var1.addPropertyChangeListener(new StyleFactory.RepaintTextComponentPropertyChangeListener((StyleFactory.RepaintTextComponentPropertyChangeListener)null));
      }
   ...
   private static class CellRendererHoverListener extends MouseAdapter {
      ...
      // $FF: synthetic method
      CellRendererHoverListener(StyleFactory.CellRendererHoverListener var1) {
         this();
      }
   }
      ...
      void restoreAllComponentProperties() {
         synchronized(this.componentProperties) {
            ...
            while(true) {
               ...
               StyleFactory.ComponentProperty var2 = (StyleFactory.ComponentProperty)var3.next();
      ...
      private void restoreComponentProperty(StyleFactory.ComponentProperty var1) {
         ...
         if (var2 != null) {
            ...
            if (var3.equals("SYCP_OPAQUE") && StyleFactory.this.prepareMetalLAFSwitch) {
               ...
               ((Separator)var2).setSeparatorSize(var5);
   ...
   private static class RepaintFocusListener implements FocusListener {
      ...
      // $FF: synthetic method
      RepaintFocusListener(StyleFactory.RepaintFocusListener var1) {
         this();
      }
   }
   ...
   private static class RepaintTextComponentPropertyChangeListener implements PropertyChangeListener {
      ...
      // $FF: synthetic method
      RepaintTextComponentPropertyChangeListener(StyleFactory.RepaintTextComponentPropertyChangeListener var1) {
         this();
      }
   }
   ...
   private static class SyntheticaComboPopupBorder implements Border {
      ...
      // $FF: synthetic method
      SyntheticaComboPopupBorder(StyleFactory.SyntheticaComboPopupBorder var1) {
         this();
      }
   }
}
