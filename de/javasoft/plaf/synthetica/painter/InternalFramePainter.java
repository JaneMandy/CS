...
public class InternalFramePainter extends SyntheticaComponentPainter {
   ...
   private String getTitle(Container var1) {
      ...
      } else if (var1 instanceof JDesktopIcon) {
         var2 = ((JDesktopIcon)var1).getInternalFrame().getTitle();
      }
   ...
   private void setIcons(BasicInternalFrameTitlePane var1, SynthContext var2) {
      ...
      if (!var6 || (!var5.endsWith("maximizeButton") || !(var10 instanceof JInternalFrame)) && (!var5.endsWith("iconifyButton") || !(var10 instanceof JDesktopIcon))) {
         if (var4 && (var3.endsWith("maximizeButton") && var10 instanceof JInternalFrame || var3.endsWith("iconifyButton") && var10 instanceof JDesktopIcon)) {
      ...
      } else if (var10 instanceof JDesktopIcon) {
         if (var16 != null) {
            var16.setIcon(var15);
         }
