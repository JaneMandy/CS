...
public class SyntheticaMenuItemUI extends BasicMenuItemUI implements PropertyChangeListener, SynthConstants {
   ...
   static Dimension getPreferredMenuItemSize(SynthContext var0, SynthContext var1, boolean var2, JComponent var3, Icon var4, Icon var5, int var6, String var7) {
      ...
      Rectangle var10000;
      if (var13 != null) {
         SyntheticaMenuItemUI.MaxWidth var21 = (SyntheticaMenuItemUI.MaxWidth)maxWidths.get(var13);
         if (var21 == null) {
            maxWidths.put(var13, new SyntheticaMenuItemUI.MaxWidth((SyntheticaMenuItemUI.MaxWidth)null));
            var21 = (SyntheticaMenuItemUI.MaxWidth)maxWidths.get(var13);
   ...
   private static String layoutMenuItem(SynthContext var0, FontMetrics var1, SynthContext var2, String var3, FontMetrics var4, String var5, Icon var6, Icon var7, Icon var8, int var9, int var10, int var11, int var12, Rectangle var13, Rectangle var14, Rectangle var15, Rectangle var16, Rectangle var17, Rectangle var18, int var19, int var20, boolean var21) {
      ...
      if (var23 != null) {
         SyntheticaMenuItemUI.MaxWidth var34 = (SyntheticaMenuItemUI.MaxWidth)maxWidths.get(var23);
         if (var34 == null) {
            maxWidths.put(var23, new SyntheticaMenuItemUI.MaxWidth((SyntheticaMenuItemUI.MaxWidth)null));
            var34 = (SyntheticaMenuItemUI.MaxWidth)maxWidths.get(var23);
         }
      ...
      int var38 = maxWidths.get(var23) == null ? var16.width : ((SyntheticaMenuItemUI.MaxWidth)maxWidths.get(var23)).maxAcceleratorWidth;
      if (var24) {
   ...
   private static class MaxWidth {
      ...
      // $FF: synthetic method
      MaxWidth(SyntheticaMenuItemUI.MaxWidth var1) {
         this();
      }
   }
}
