...
public class SyntheticaDefaultTableCellEditor extends DefaultCellEditor {
   ...
   protected Border createCellFocusBorder(JTable var1) {
      ...
      return new SyntheticaDefaultTableCellEditor.CellFocusBorder(SyntheticaLookAndFeel.getColor("Synthetica.table.cellEditor.focus.color", var1, var2));
   }

   protected Border createErrorCellFocusBorder(JTable var1) {
      return new SyntheticaDefaultTableCellEditor.CellFocusBorder(SyntheticaLookAndFeel.getColor("Synthetica.table.cellEditor.focus.errorColor", var1, new Color(15138816)));
   }
