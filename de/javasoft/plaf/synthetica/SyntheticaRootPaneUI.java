...
public class SyntheticaRootPaneUI extends BasicRootPaneUI {
   ...
   private SyntheticaRootPaneUI.MouseEventProcessor mouseEventProcessor;
   ...
   private SyntheticaRootPaneUI.SnapState snapState;
   ...
   private void installWindowListeners(JRootPane root, Component parent) {
      ...
      if (this.window != null) {
         if (this.getMouseInputListener() == null) {
            this.setMouseInputListener(new SyntheticaRootPaneUI.MouseInputHandler());
         }

         if (this.getAWTMouseInputListener() == null) {
            this.setAWTMouseInputListener(new SyntheticaRootPaneUI.AWTMouseInputHandler());
         }
   ...
   private void uninstallWindowListeners(JRootPane root) {
      ...
      if (this.mouseInputListener instanceof SyntheticaRootPaneUI.MouseInputHandler) {
   ...
   private void installLayout(JRootPane root) {
      if (this.layoutManager == null) {
         this.layoutManager = new SyntheticaRootPaneUI.SyntheticaRootLayout();
      }
   ...
   private void setAWTMouseInputListener(AWTEventListener listener) {
      ...
      if (this.getMouseEventProcesor() == null) {
         this.mouseEventProcessor = new SyntheticaRootPaneUI.MouseEventProcessor();
      }
   ...
   public SyntheticaRootPaneUI.MouseEventProcessor getMouseEventProcesor() {
      return this.mouseEventProcessor;
   }

   public void setMouseEventProcessor(SyntheticaRootPaneUI.MouseEventProcessor processor) {
   ...
   private JComponent getProperHeaderShadowComponent() {
      if (this.rootPane == null) {
         ...
         SyntheticaRootPaneUI.HeaderShadowType type = this.getHeaderShadowType();
   ...
   private SyntheticaRootPaneUI.HeaderShadowType getHeaderShadowType() {
   ...
   private Rectangle justifySnapBounds(Rectangle bounds, SyntheticaRootPaneUI.SnapState state) {
      ...
      public void process(JRootPane root, MouseEvent evt) {
         ...
         if (!doNotHandle) {
            ...
            if (mouseInputListener != null) {
               ...
               if (mouseInputListener instanceof SyntheticaRootPaneUI.MouseInputHandler && ((SyntheticaRootPaneUI.MouseInputHandler)mouseInputListener).isResizing()) {
                  evt.consume();
               }
