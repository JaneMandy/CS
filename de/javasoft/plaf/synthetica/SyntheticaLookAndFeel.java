...
public abstract class SyntheticaLookAndFeel extends SynthLookAndFeel {
   ...
   private void installCompatibilityDefaults(UIDefaults var1) {
      ...
      if (var1.get("Synthetica.table.scrollPaneBorder.className") != null) {
         ...
         var28 = new LineBorderUIResource(var1.getColor("Synthetica.table.scrollPane.border.color"), var29);
      }
      ...
      if (uiScaleEnabled != null) {
         ...
         if (!GraphicsEnvironment.isHeadless()) {
            ...
            for(int var2 = 0; var2 < var3; ++var2) {
               ...
               if (var1.getDefaultConfiguration().getDefaultTransform().getScaleX() > 1.0D || var1.getDefaultConfiguration().getDefaultTransform().getScaleY() > 1.0D) {
