...
public class PostExObfuscator {
   ...
   public void obfuscateDOSHeader() {
      int var1 = this.editor.getInfo().getLocation("e_lfanew");
      byte[] var2 = CommonUtils.randomData(var1 - 2);
      this.editor.setString(2, var2);
   }
   ...
   public void process(byte[] var1) {
      ...
      if ("true".equalsIgnoreCase(TeamServerProps.getPropsFile().getString("logging.PEEditor_PostExObfuscator", "false"))) {
         this.editor.setLogActions(true);
      }
