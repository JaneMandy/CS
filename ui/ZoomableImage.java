...
public class ZoomableImage extends JLabel {
   ...
   private JMenuItem A(String var1, final double var2) {
   ...
   public ZoomableImage() {
      ...
      var1.add(this.A("25%", 0.25D));
      var1.add(this.A("50%", 0.5D));
      var1.add(this.A("75%", 0.75D));
      var1.add(this.A("100%", 1.0D));
      var1.add(this.A("125%", 1.25D));
      var1.add(this.A("150%", 1.5D));
      var1.add(this.A("200%", 2.0D));
      var1.add(this.A("250%", 2.5D));
