...
public class KeyBindings implements KeyEventDispatcher {
      ...
      synchronized(this) {
         if (this.bindings.containsKey(var2.toString())) {
            ...
            if (var1.getID() != 401) {
               ...
               CommonUtils.runSafe(new KeyBindings._A(var2.toString(), (KeyHandler)this.bindings.get(var2.toString())));
               return true;
            }
         } else {
            return false;
   ...
   private static String A(KeyEvent var0) {
   ...
   private static String B(KeyEvent var0) {
   ...
   private static class _A implements Runnable {
      protected String B;
      protected KeyHandler A;

      public _A(String var1, KeyHandler var2) {
         this.B = var1;
         this.A = var2;
      }

      public void run() {
         this.A.key_pressed(this.B);
      }
   }
}
