...
public class GenericTableModel extends AbstractTableModel {
   ...
   public boolean removeRowWithValueAtColumn(String var1, String var2) {
      int var3 = 0;
      CommonUtils.Guard();
      synchronized(this) {
         ...
         while(var10.hasNext()) {
            Map var7 = (Map)var10.next();
            if (var2.equals(var7.get(var1))) {
               var10.remove();
               ++var3;
            }
         }
   ...
   public boolean hasSelectedRows(JTable var1) {
      synchronized(this) {
         return var1.getSelectedRowCount() > 0;
      }
   }
   ...
   public boolean setValueForKeyAtColumn(String var1, String var2, String var3, String var4) {
      int var5 = -1;
      synchronized(this) {
         ...
         while(var7.hasNext()) {
            Map var9 = (Map)var7.next();
            if (!var2.equals(var9.get(var1))) {
               ++var8;
            } else {
               var5 = var8;
               break;
      ...
      if (var5 != -1) {
         this.setValueAtRow(var5, var3, var4);
      }
