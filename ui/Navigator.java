...
public class Navigator extends JComponent implements ListSelectionListener {
   ...
   public Navigator() {
      ...
      this.navigator.setCellRenderer(new Navigator._A());
   ...
   public void useAlternateValue(boolean var1) {
      this.useAlternateValue = var1;
   ...
   private class _A extends JLabel implements ListCellRenderer {
      ...
      public Component getListCellRendererComponent(JList var1, Object var2, int var3, boolean var4, boolean var5) {
         ...
         String var7 = Navigator.this.useAlternateValue && var6.length == 2 ? var6[1] : var6[0];
         boolean var8 = false;
         if ('*' == var7.charAt(0)) {
            var8 = true;
