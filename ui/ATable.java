      ...
      if (this.selected.length == 0) {
         ...
         for(int var3 = 0; var3 < this.selected.length; ++var3) {
            if (this.selected[var3] < var1) {
               var2 = true;
               this.getSelectionModel().addSelectionInterval(this.selected[var3], this.selected[var3]);
            }
         }

         if (!var2 && var1 > 0) {
            this.getSelectionModel().addSelectionInterval(var1 - 1, var1 - 1);
         }
         ...
         public Component getTableCellRendererComponent(JTable var1, Object var2x, boolean var3, boolean var4, int var5, int var6) {
            ...
            if (!var3) {
               if ("neutral".equals(var8)) {
                  ...
                  var7.setBackground(ATable.this.alternateBackground ? ATable.A : Color.WHITE);
               }
