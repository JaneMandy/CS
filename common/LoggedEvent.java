...
public class LoggedEvent implements Serializable, Scriptable, Transcript, Loggable, Informant {
   ...
   public static final LoggedEvent Join(String var0, String var1) {
      return new LoggedEvent(var0, (String)null, (short)2, var1);
   }
   ...
   public void formatEvent(DataOutputStream var1) throws IOException {
      ...
      case 1:
         return;
      case 2:
         var2.append("*** " + this.from + " (" + this.text + ") joined\n");
         break;
      case 3:
