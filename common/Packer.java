...
public class Packer {
   ...
   public void padTo(char var1, int var2) {
      while(this.size() < (long)var2) {
         this.addByte(var1);
      }
   ...
   public void addEncodedString(AggressorClient var1, String var2, String var3) {
      this.append(DataUtils.encodeForBeacon(var1.getData(), var2, var3));
   }

   public void addLengthAndEncodedString(AggressorClient var1, String var2, String var3) {
      this.addLengthAndString(DataUtils.encodeForBeacon(var1.getData(), var2, var3));
   }
