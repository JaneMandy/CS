...
public class ListenerUtils {
   ...
   public static boolean checkIPAddress(Map var0, String var1, String var2) {
      String var3 = (String)var0.get(var1);
      String var4 = "(\\d{1,2}|(0|1)\\d{2}|2[0-4]\\d|25[0-5])";
      String var5 = var4 + "\\." + var4 + "\\." + var4 + "\\." + var4;
      Pattern var6 = Pattern.compile(var5);
      if (!"".equals(var3) && var3 != null) {
         Matcher var7 = var6.matcher(var3);
         if (!var7.matches()) {
            DialogUtils.showError(var2 + " is not a valid IP V4 Address.");
            return false;
         } else {
            return true;
         }
      ...
      if (var1 != null && !"".equals(var1)) {
         if (var4 != null && !"".equals(var4)) {
            if (var4.equals("windows/beacon_bind_tcp")) {
               ...
               if (!checkIPAddress(var0, "dnsresolver", "DNS Resolver")) {
                  return false;
               }
   ...
   public static Map dialogToMap(Map var0) {
      ...
      var1.put("name", var2);
      if (var0.containsKey("_accent")) {
         var1.put("_accent", var0.get("_accent"));
      }
      ...
      if ("Beacon HTTP".equals(var3)) {
         ...
         var1.put("strategy", DialogUtils.string(var0, "http_strategy"));
         ...
         var1.put("strategy", DialogUtils.string(var0, "https_strategy"));
         ...
         var1.put("strategy", DialogUtils.string(var0, "dns_strategy"));
         var1.put("host", DialogUtils.string(var0, "dns_host"));
         var1.put("bindto", DialogUtils.string(var0, "dns_bind"));
         var1.put("port", "53");
         var1.put("profile", DialogUtils.string(var0, "dns_profile"));
         var1.put("dnsresolver", DialogUtils.string(var0, "dns_resolver"));
   ...
   public static Map mapToDialog(Map var0) {
      ...
      if ("windows/beacon_http/reverse_http".equals(var3)) {
         ...
         var1.put("http_strategy", var0.get("strategy"));
         ...
         var1.put("https_strategy", var0.get("strategy"));
         ...
         var1.put("dns_strategy", var0.get("strategy"));
         var1.put("dns_bind", var0.get("bindto"));
         var1.put("dns_profile", var0.get("profile"));
         var1.put("dns_resolver", DialogUtils.string(var0, "dnsresolver"));
