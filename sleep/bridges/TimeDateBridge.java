...
public class TimeDateBridge implements Loadable {
   public void scriptLoaded(ScriptInstance var1) {
      var1.getScriptEnvironment().getEnvironment().put("&ticks", new TimeDateBridge.ticks());
      var1.getScriptEnvironment().getEnvironment().put("&formatDate", new TimeDateBridge.formatDate());
      var1.getScriptEnvironment().getEnvironment().put("&parseDate", new TimeDateBridge.parseDate());
   }
