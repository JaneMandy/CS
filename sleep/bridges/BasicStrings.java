...
public class BasicStrings implements Loadable, Predicate {
   ...
   public void scriptLoaded(ScriptInstance var1) {
      ...
      var2.put("&left", new BasicStrings.func_left());
      var2.put("&right", new BasicStrings.func_right());
      var2.put("&charAt", new BasicStrings.func_charAt());
      var2.put("&byteAt", var2.get("&charAt"));
      var2.put("&uc", new BasicStrings.func_uc());
      var2.put("&lc", new BasicStrings.func_lc());
      BasicStrings.func_substr var3 = new BasicStrings.func_substr();
      var2.put("&substr", var3);
      var2.put("&mid", var3);
      var2.put("&indexOf", new BasicStrings.func_indexOf());
      var2.put("&lindexOf", var2.get("&indexOf"));
      var2.put("&strlen", new BasicStrings.func_strlen());
      var2.put("&strrep", new BasicStrings.func_strrep());
      var2.put("&replaceAt", new BasicStrings.func_replaceAt());
      var2.put("&tr", new BasicStrings.func_tr());
      var2.put("&asc", new BasicStrings.func_asc());
      var2.put("&chr", new BasicStrings.func_chr());
      var2.put("&sort", new BasicStrings.func_sort());
      BasicStrings.func_sorters var4 = new BasicStrings.func_sorters();
      var2.put("&sorta", var4);
      var2.put("&sortn", var4);
      var2.put("&sortd", var4);
      var2.put("eq", this);
      ...
      var2.put("isin", this);
      var2.put("iswm", new BasicStrings.pred_iswm());
      var2.put(".", new BasicStrings.oper_concat());
      var2.put("x", new BasicStrings.oper_multiply());
      var2.put("cmp", new BasicStrings.oper_compare());
      var2.put("<=>", new BasicStrings.oper_spaceship());
   }
   ...
   private static class func_chr implements Function {
      ...
      public Scalar evaluate(String var1, ScriptInstance var2, Stack var3) {
         return SleepUtils.getScalar(((char)BridgeUtilities.getInt(var3)).makeConcatWithConstants<invokedynamic>((char)BridgeUtilities.getInt(var3)));
      }
   ...
   private static class func_charAt implements Function {
      ...
      public Scalar evaluate(String var1, ScriptInstance var2, Stack var3) {
         ...
         int var5 = BridgeUtilities.getInt(var3);
         Scalar var6;
         if (var1.equals("&charAt")) {
            char var10000 = BasicStrings.charAt(var4, var5);
            var6 = SleepUtils.getScalar(var10000.makeConcatWithConstants<invokedynamic>(var10000));
         } else {
            var6 = SleepUtils.getScalar((int)BasicStrings.charAt(var4, var5));
         }
      ...
      public Scalar evaluate(String var1, ScriptInstance var2, Stack var3) {
         if (var3.size() != 2) {
            ...
            if (var4 == null) {
               ...
               var5.sort(new BasicStrings.CompareFunction(var4, var2));
   ...
   private static class func_sorters implements Function {
      ...
      public Scalar evaluate(String var1, ScriptInstance var2, Stack var3) {
         ...
         if (var1.equals("&sorta")) {
            var4.sort(new BasicStrings.CompareStrings());
         } else if (var1.equals("&sortn")) {
            var4.sort(new BasicStrings.CompareNumbers());
         } else if (var1.equals("&sortd")) {
            var4.sort(new BasicStrings.CompareDoubles());
         }
   ...
   private static class oper_concat implements Operator {
      ...
      public Scalar operate(String var1, ScriptInstance var2, Stack var3) {
         ...
         if (var1.equals(".")) {
            ...
            var6 = SleepUtils.getScalar(var10000 + var5.toString());
         } else {
            var6 = null;
         }
