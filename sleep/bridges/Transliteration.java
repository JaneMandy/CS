...
public class Transliteration {
   ...
   private Transliteration.Element pattern = null;

   public String toString() {
      StringBuffer var1 = new StringBuffer();
      StringBuffer var2 = new StringBuffer();

      for(Transliteration.Element var3 = this.pattern; var3 != null; var3 = var3.next) {
         if (var3.isSpecial) {
            switch(var3.item) {
            case '.':
               var1.append("[:ANY:]");
   ...
   private Transliteration.Element buildPattern(String var1, String var2) {
      Transliteration.Element var3 = null;
      Transliteration.Element var4 = null;
      ...
      while(var5.current() != '\uffff') {
         if (var4 == null) {
            var3 = new Transliteration.Element();
            var4 = var3;
         } else {
            var4.next = new Transliteration.Element();
            var4 = var4.next;
         }
   ...
   private boolean isMatch(char var1, Transliteration.Element var2) {
      boolean var3 = false;
      if (var2.isSpecial) {
         switch(var2.item) {
         case '.':
   ...
   private static class Element {
      ...
      public Transliteration.Element next;
