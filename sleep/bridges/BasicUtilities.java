...
public class BasicUtilities implements Function, Loadable, Predicate {
   ...
   public void scriptLoaded(ScriptInstance var1) {
      ...
      BasicUtilities.array var3 = new BasicUtilities.array();
      BasicUtilities.hash var4 = new BasicUtilities.hash();
      var2.put("&array", var3);
      var2.put("&hash", var4);
      var2.put("&ohash", var4);
      ...
      var2.put("&copy", new BasicUtilities.copy());
      ...
      BasicUtilities.map var5 = new BasicUtilities.map();
      var2.put("&map", var5);
      var2.put("&filter", var5);
      BasicUtilities.f_cast var6 = new BasicUtilities.f_cast();
      var2.put("&cast", var6);
      var2.put("&casti", var6);
      ...
      var2.put("&exit", this);
      BasicUtilities.SetScope var7 = new BasicUtilities.SetScope();
      var2.put("&local", var7);
      var2.put("&this", var7);
      ...
      var2.put("&reverse", new BasicUtilities.reverse());
      var2.put("&removeAt", new BasicUtilities.removeAt());
      var2.put("&shift", new BasicUtilities.shift());
      var2.put("&systemProperties", new BasicUtilities.systemProperties());
      var2.put("&use", TaintUtils.Sensitive(new BasicUtilities.f_use()));
      var2.put("&include", TaintUtils.Sensitive((Function)var2.get("&use")));
      var2.put("&checkError", this);
      var2.put("&lambda", new BasicUtilities.lambda());
      var2.put("&compile_closure", TaintUtils.Sensitive((Function)var2.get("&lambda")));
      var2.put("&let", var2.get("&lambda"));
      BasicUtilities.function var8 = new BasicUtilities.function();
      var2.put("&function", TaintUtils.Sensitive(var8));
      var2.put("function", var2.get("&function"));
      var2.put("&setf", var8);
      var2.put("&eval", TaintUtils.Sensitive(new BasicUtilities.eval()));
      var2.put("&expr", TaintUtils.Sensitive((Function)var2.get("&eval")));
      BasicUtilities.SyncPrimitives var9 = new BasicUtilities.SyncPrimitives();
      var2.put("&semaphore", var9);
      var2.put("&acquire", var9);
      var2.put("&release", var9);
      var2.put("&invoke", this);
      var2.put("&inline", this);
      var2.put("=>", new BasicUtilities.HashKeyValueOp());
   }
