...
public class FileSystemBridge implements Loadable, Function, Predicate {
   ...
   public void scriptLoaded(ScriptInstance var1) {
      ...
      var2.put("&getFileName", new FileSystemBridge.getFileName());
      var2.put("&getFileProper", new FileSystemBridge.getFileProper());
      var2.put("&getFileParent", new FileSystemBridge.getFileParent());
      var2.put("&lastModified", new FileSystemBridge.lastModified());
      var2.put("&lof", new FileSystemBridge.lof());
      var2.put("&ls", new FileSystemBridge.listFiles());
