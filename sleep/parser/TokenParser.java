   ...
   public static Statement ParseObject(Parser var0, TokenList var1) {
      ...
      if (var2.length < 1) {
         ...
         if (var3.length >= 2 && var3[1].equals(".")) {
            ...
            Token var12 = var2[0].copy(var6.toString());
            TokenList var13 = new TokenList();
            var13.add(var12);
            ...
            if (var10 >= var2.length) {
               ...
               int var11 = var10 + 1;
               var6 = new StringBuffer(var3[var11]);
               ++var11;

               while(var11 < var2.length) {
                  var6.append(" ");
                  var6.append(var3[var11]);
                  ++var11;
               }

               var4.add(new Token(var6.toString(), var2[var11 - 1].getHint()));
               return var4;
            }
         }
      }
