...
public class ScriptInstance implements Serializable, Runnable {
   ...
   public void recordStackFrame(String var1, String var2, int var3) {
      ...
      ScriptInstance.SleepStackElement var5 = new ScriptInstance.SleepStackElement();
   ...
   public void collect(String var1, int var2, long var3) {
      ...
      ScriptInstance.ProfilerStatistic var7 = (ScriptInstance.ProfilerStatistic)((Map)var5).get(var1);
      if (var7 == null) {
         var7 = new ScriptInstance.ProfilerStatistic();
   ...
   public static class ProfilerStatistic implements Comparable, Serializable {
      ...
      public int compareTo(Object var1) {
         return (int)(((ScriptInstance.ProfilerStatistic)var1).ticks - this.ticks);
      }
