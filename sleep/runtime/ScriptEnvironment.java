...
public class ScriptEnvironment implements Serializable {
   ...
   protected ScriptEnvironment.ExceptionContext currentHandler = null;
      ...
      while(true) {
         do {
            do {
               ...
               ScriptEnvironment.Context var4 = (ScriptEnvironment.Context)var3.next();
   ...
   public void installExceptionHandler(ScriptEnvironment.ExceptionContext var1) {
   ...
   public void installExceptionHandler(Block var1, Block var2, String var3) {
      ScriptEnvironment.ExceptionContext var4 = new ScriptEnvironment.ExceptionContext();
      var4.owner = var1;
      var4.handler = var2;
      var4.varname = var3;
   ...
   public ScriptEnvironment.ExceptionContext popExceptionContext() {
      ScriptEnvironment.ExceptionContext var1 = this.currentHandler;
      if (this.exhandlers.isEmpty()) {
         this.currentHandler = null;
      } else {
         this.currentHandler = (ScriptEnvironment.ExceptionContext)this.exhandlers.pop();
      }
