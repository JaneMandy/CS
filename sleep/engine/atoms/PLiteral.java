...
public class PLiteral extends Step {
   ...
   public String toString(String var1) {
      ...
      while(var3.hasNext()) {
         PLiteral.Fragment var4 = (PLiteral.Fragment)var3.next();
         switch(var4.type) {
         case 1:
   ...
   public static PLiteral.Fragment fragment(int var0, Object var1) {
      PLiteral.Fragment var2 = new PLiteral.Fragment();
      var2.element = var1;
      var2.type = var0;
      return var2;
   }
   ...
   private String buildString(ScriptEnvironment var1) {
      ...
      while(true) {
         while(var5.hasNext()) {
            PLiteral.Fragment var6 = (PLiteral.Fragment)var5.next();
            switch(var6.type) {
            case 1:
