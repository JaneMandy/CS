...
public class Iterate extends Step {
   ...
   private void iterator_next(ScriptEnvironment var1) {
      ...
      if (var3.iterator != null && var3.iterator.hasNext()) {
         ...
         if (var3.source.getHash() != null) {
            if (SleepUtils.isEmptyScalar((Scalar)((Entry)var4).getValue())) {
            ...
            if (var3.key != null) {
               var3.kenv.putScalar(var3.key, SleepUtils.getScalar(((Entry)var4).getKey()));
               var3.venv.putScalar(var3.value, (Scalar)((Entry)var4).getValue());
            } else {
               var3.venv.putScalar(var3.value, SleepUtils.getScalar(((Entry)var4).getKey()));
            }
