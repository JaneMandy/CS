...
public class MyLinkedList extends AbstractSequentialList implements Cloneable, Serializable, List {
   ...
   private class SublistHeaderEntry implements MyLinkedList.ListEntry {
      ...
      public MyLinkedList.ListEntry previous() {
         MyLinkedList var10002 = MyLinkedList.this;
         Objects.requireNonNull(var10002);
         return var10002.new ListEntryWrapper(this.anchorRight.previous());
      }

      public MyLinkedList.ListEntry next() {
         MyLinkedList var10002 = MyLinkedList.this;
         Objects.requireNonNull(var10002);
         return var10002.new ListEntryWrapper(this.anchorLeft.next());
      }
   ...
   private class ListEntryWrapper implements MyLinkedList.ListEntry {
      ...
      public MyLinkedList.ListEntry remove() {
         ...
         if (MyLinkedList.this.size == 0) {
            ...
            MyLinkedList var10002 = MyLinkedList.this;
            Objects.requireNonNull(var10002);
            return var10002.new ListEntryWrapper(var1);
         }
      }
      ...
      public MyLinkedList.ListEntry addBefore(Object var1) {
         ...
         MyLinkedList var10002 = MyLinkedList.this;
         Objects.requireNonNull(var10002);
         return var10002.new ListEntryWrapper(var2);
      }
      ...
      public MyLinkedList.ListEntry next() {
         MyLinkedList.this.checkSafety();
         MyLinkedList var10002;
         if (this.parent == MyLinkedList.this.header.next()) {
            var10002 = MyLinkedList.this;
            Objects.requireNonNull(var10002);
            return var10002.new ListEntryWrapper(MyLinkedList.this.header);
         } else {
            var10002 = MyLinkedList.this;
            Objects.requireNonNull(var10002);
            MyLinkedList.ListEntryWrapper var1 = var10002.new ListEntryWrapper(this.parent.next());
            return var1;
         }
      }
      ...
      public MyLinkedList.ListEntry previous() {
         ...
         if (this.parent == MyLinkedList.this.header.previous()) {
            ...
            var10002 = MyLinkedList.this;
            Objects.requireNonNull(var10002);
            MyLinkedList.ListEntryWrapper var1 = var10002.new ListEntryWrapper(this.parent.previous());
            return var1;
         }
      }
   }
   ...
   private class NormalListEntry implements MyLinkedList.ListEntry {
      ...
      public MyLinkedList.ListEntry addBefore(Object var1) {
         MyLinkedList var10002 = MyLinkedList.this;
         Objects.requireNonNull(var10002);
         MyLinkedList.NormalListEntry var2 = var10002.new NormalListEntry(var1, this.previous, this);
         ++MyLinkedList.this.size;
         MyLinkedList.this.modCount++;
         return var2;
      }
      ...
      public MyLinkedList.ListEntry addAfter(Object var1) {
         MyLinkedList var10002 = MyLinkedList.this;
         Objects.requireNonNull(var10002);
         MyLinkedList.NormalListEntry var2 = var10002.new NormalListEntry(var1, this, this.next);
         ++MyLinkedList.this.size;
         MyLinkedList.this.modCount++;
         return var2;
      }
