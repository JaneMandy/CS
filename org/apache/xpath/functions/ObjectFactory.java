...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xpath$functions$ObjectFactory == null ? (class$org$apache$xpath$functions$ObjectFactory = class$("org.apache.xpath.functions.ObjectFactory")) : class$org$apache$xpath$functions$ObjectFactory;
         synchronized(var53) {
