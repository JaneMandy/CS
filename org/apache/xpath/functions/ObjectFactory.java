...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xpath$functions$ObjectFactory == null ? (class$org$apache$xpath$functions$ObjectFactory = class$("org.apache.xpath.functions.ObjectFactory")) : class$org$apache$xpath$functions$ObjectFactory;
         synchronized(var18) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xpath$functions$ObjectFactory == null ? (class$org$apache$xpath$functions$ObjectFactory = class$("org.apache.xpath.functions.ObjectFactory")) : class$org$apache$xpath$functions$ObjectFactory).getClassLoader();
