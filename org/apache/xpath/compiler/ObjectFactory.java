...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xpath$compiler$ObjectFactory;
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xpath$compiler$ObjectFactory == null ? (class$org$apache$xpath$compiler$ObjectFactory = class$("org.apache.xpath.compiler.ObjectFactory")) : class$org$apache$xpath$compiler$ObjectFactory;
         synchronized(var18) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xpath$compiler$ObjectFactory == null ? (class$org$apache$xpath$compiler$ObjectFactory = class$("org.apache.xpath.compiler.ObjectFactory")) : class$org$apache$xpath$compiler$ObjectFactory).getClassLoader();
