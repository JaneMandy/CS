...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xml$dtm$ObjectFactory == null ? (class$org$apache$xml$dtm$ObjectFactory = class$("org.apache.xml.dtm.ObjectFactory")) : class$org$apache$xml$dtm$ObjectFactory;
         synchronized(var53) {
