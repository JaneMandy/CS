...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xml$dtm$ref$ObjectFactory;
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xml$dtm$ref$ObjectFactory == null ? (class$org$apache$xml$dtm$ref$ObjectFactory = class$("org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory;
         synchronized(var53) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xml$dtm$ref$ObjectFactory == null ? (class$org$apache$xml$dtm$ref$ObjectFactory = class$("org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory).getClassLoader();
