...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xml$dtm$ref$ObjectFactory == null ? (class$org$apache$xml$dtm$ref$ObjectFactory = class$("org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory;
         synchronized(var18) {
