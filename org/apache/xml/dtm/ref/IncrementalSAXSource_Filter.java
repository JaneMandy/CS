         ...
         try {
            ...
            if (arg == Boolean.FALSE) {
               ...
               if (this.fXMLReader != null) {
                  throw new IncrementalSAXSource_Filter.StopException();
               }
   ...
   public void run() {
      if (this.fXMLReader != null) {
         ...
         try {
            ...
            arg = var7;
         } catch (IncrementalSAXSource_Filter.StopException var8) {
            if (this.DEBUG) {
               System.out.println("Active IncrementalSAXSource_Filter normal stop exception");
            }
         } catch (SAXException var9) {
            Exception inner = var9.getException();
            if (inner instanceof IncrementalSAXSource_Filter.StopException) {
               if (this.DEBUG) {
                  System.out.println("Active IncrementalSAXSource_Filter normal stop exception");
               }
            } else {
