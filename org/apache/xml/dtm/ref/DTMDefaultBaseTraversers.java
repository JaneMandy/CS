...
public abstract class DTMDefaultBaseTraversers extends DTMDefaultBase {
   ...
   public DTMAxisTraverser getAxisTraverser(int axis) {
      ...
      switch(axis) {
      case 0:
         traverser = new DTMDefaultBaseTraversers.AncestorTraverser();
         break;
      case 1:
         traverser = new DTMDefaultBaseTraversers.AncestorOrSelfTraverser();
         break;
      case 2:
         traverser = new DTMDefaultBaseTraversers.AttributeTraverser();
         break;
      case 3:
         traverser = new DTMDefaultBaseTraversers.ChildTraverser();
         break;
      case 4:
         traverser = new DTMDefaultBaseTraversers.DescendantTraverser();
         break;
      case 5:
         traverser = new DTMDefaultBaseTraversers.DescendantOrSelfTraverser();
         break;
      case 6:
         traverser = new DTMDefaultBaseTraversers.FollowingTraverser();
         break;
      case 7:
         traverser = new DTMDefaultBaseTraversers.FollowingSiblingTraverser();
         break;
      case 8:
         traverser = new DTMDefaultBaseTraversers.NamespaceDeclsTraverser();
         break;
      case 9:
         traverser = new DTMDefaultBaseTraversers.NamespaceTraverser();
         break;
      case 10:
         traverser = new DTMDefaultBaseTraversers.ParentTraverser();
         break;
      case 11:
         traverser = new DTMDefaultBaseTraversers.PrecedingTraverser();
         break;
      case 12:
         traverser = new DTMDefaultBaseTraversers.PrecedingSiblingTraverser();
         break;
      case 13:
         traverser = new DTMDefaultBaseTraversers.SelfTraverser();
         break;
      case 14:
         traverser = new DTMDefaultBaseTraversers.AllFromNodeTraverser();
         break;
      case 15:
         traverser = new DTMDefaultBaseTraversers.PrecedingAndAncestorTraverser();
         break;
      case 16:
         traverser = new DTMDefaultBaseTraversers.AllFromRootTraverser();
         break;
      case 17:
         traverser = new DTMDefaultBaseTraversers.DescendantFromRootTraverser();
         break;
      case 18:
         traverser = new DTMDefaultBaseTraversers.DescendantOrSelfFromRootTraverser();
         break;
      case 19:
         traverser = new DTMDefaultBaseTraversers.RootTraverser();
         break;
      case 20:
         return null;
      default:
