...
public abstract class DTMDefaultBaseIterators extends DTMDefaultBaseTraversers {
   ...
   public DTMAxisIterator getTypedAxisIterator(int axis, int type) {
      ...
      switch(axis) {
      case 0:
         return new DTMDefaultBaseIterators.TypedAncestorIterator(type);
      case 1:
         return (new DTMDefaultBaseIterators.TypedAncestorIterator(type)).includeSelf();
      case 2:
         return new DTMDefaultBaseIterators.TypedAttributeIterator(type);
      case 3:
         iterator = new DTMDefaultBaseIterators.TypedChildrenIterator(type);
         break;
      case 4:
         iterator = new DTMDefaultBaseIterators.TypedDescendantIterator(type);
         break;
      case 5:
         iterator = (new DTMDefaultBaseIterators.TypedDescendantIterator(type)).includeSelf();
         break;
      case 6:
         iterator = new DTMDefaultBaseIterators.TypedFollowingIterator(type);
         break;
      case 7:
         iterator = new DTMDefaultBaseIterators.TypedFollowingSiblingIterator(type);
         break;
      case 8:
      case 14:
      case 15:
      ...
      case 9:
         ...
         break;
      case 10:
         return (new DTMDefaultBaseIterators.ParentIterator()).setNodeType(type);
      case 11:
         iterator = new DTMDefaultBaseIterators.TypedPrecedingIterator(type);
         break;
      case 12:
         iterator = new DTMDefaultBaseIterators.TypedPrecedingSiblingIterator(type);
         break;
      case 13:
         iterator = new DTMDefaultBaseIterators.TypedSingletonIterator(type);
         break;
      case 19:
         iterator = new DTMDefaultBaseIterators.TypedRootIterator(type);
      }
   ...
   public DTMAxisIterator getAxisIterator(int axis) {
      ...
      switch(axis) {
      case 0:
         return new DTMDefaultBaseIterators.AncestorIterator();
      case 1:
         return (new DTMDefaultBaseIterators.AncestorIterator()).includeSelf();
      case 2:
         return new DTMDefaultBaseIterators.AttributeIterator();
      case 3:
         iterator = new DTMDefaultBaseIterators.ChildrenIterator();
         break;
      case 4:
         iterator = new DTMDefaultBaseIterators.DescendantIterator();
         break;
      case 5:
         iterator = (new DTMDefaultBaseIterators.DescendantIterator()).includeSelf();
         break;
      case 6:
         iterator = new DTMDefaultBaseIterators.FollowingIterator();
         break;
      case 7:
         iterator = new DTMDefaultBaseIterators.FollowingSiblingIterator();
         break;
      case 8:
      case 14:
      case 15:
      ...
      case 9:
         ...
         break;
      case 10:
         return new DTMDefaultBaseIterators.ParentIterator();
      case 11:
         iterator = new DTMDefaultBaseIterators.PrecedingIterator();
         break;
      case 12:
         iterator = new DTMDefaultBaseIterators.PrecedingSiblingIterator();
         break;
      case 13:
         iterator = new DTMDefaultBaseIterators.SingletonIterator();
         break;
      case 19:
         iterator = new DTMDefaultBaseIterators.RootIterator();
      }
   ...
   public class AncestorIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         ...
         try {
            DTMDefaultBaseIterators.AncestorIterator clone = (DTMDefaultBaseIterators.AncestorIterator)super.clone();
   ...
   public class PrecedingIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         ...
         try {
            DTMDefaultBaseIterators.PrecedingIterator clone = (DTMDefaultBaseIterators.PrecedingIterator)super.clone();
