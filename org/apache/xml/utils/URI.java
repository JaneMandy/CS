...
public class URI implements Serializable {
   ...
   public URI(String p_scheme, String p_userinfo, String p_host, int p_port, String p_path, String p_queryString, String p_fragment) throws URI.MalformedURIException {
      ...
      if (p_scheme != null && p_scheme.trim().length() != 0) {
         if (p_host == null) {
            if (p_userinfo != null) {
               throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_USERINFO_IF_NO_HOST", (Object[])null));
            }

            if (p_port != -1) {
               throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_PORT_IF_NO_HOST", (Object[])null));
            }
         }

         if (p_path != null) {
            if (p_path.indexOf(63) != -1 && p_queryString != null) {
               throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_QUERY_STRING_IN_PATH", (Object[])null));
            }

            if (p_path.indexOf(35) != -1 && p_fragment != null) {
               throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_FRAGMENT_STRING_IN_PATH", (Object[])null));
            }
         }
         ...
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_SCHEME_REQUIRED", (Object[])null));
      }
   }
   ...
   private void initialize(URI p_base, String p_uriSpec) throws URI.MalformedURIException {
      if (p_base != null || p_uriSpec != null && p_uriSpec.trim().length() != 0) {
         if (p_uriSpec != null && p_uriSpec.trim().length() != 0) {
            ...
            if (colonIndex < 0) {
               if (p_base == null) {
                  throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_SCHEME_IN_URI", new Object[]{uriSpec}));
               }
            } else {
            ...
            if (index + 1 < uriSpecLen && uriSpec.substring(index).startsWith("//")) {
               ...
               for(boolean var8 = false; index < uriSpecLen; ++index) {
         ...
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_CANNOT_INIT_URI_EMPTY_PARMS", (Object[])null));
      }
   }
   ...
   private void initializeScheme(String p_uriSpec) throws URI.MalformedURIException {
      ...
      if (scheme.length() == 0) {
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_NO_SCHEME_INURI", (Object[])null));
      } else {
         this.setScheme(scheme);
      }
   }

   private void initializeAuthority(String p_uriSpec) throws URI.MalformedURIException {
      int index = 0;
      int start = 0;
         ...
         if (portStr.length() > 0) {
            for(int i = 0; i < portStr.length(); ++i) {
               if (!isDigit(portStr.charAt(i))) {
                  throw new URI.MalformedURIException(portStr + " is invalid. Port should only contain digits!");
               }
            }
   ...
   private void initializePath(String p_uriSpec) throws URI.MalformedURIException {
      if (p_uriSpec == null) {
               ...
               if (testChar != '?' && testChar != '#') {
                  if (testChar == '%') {
                     if (index + 2 >= end || !isHex(p_uriSpec.charAt(index + 1)) || !isHex(p_uriSpec.charAt(index + 2))) {
                        throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE", (Object[])null));
                     }
                  } else if (!isReservedCharacter(testChar) && !isUnreservedCharacter(testChar) && '\\' != testChar) {
                     throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_INVALID_CHAR", new Object[]{String.valueOf(testChar)}));
                  }
   ...
   public void setScheme(String p_scheme) throws URI.MalformedURIException {
      if (p_scheme == null) {
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_SCHEME_FROM_NULL_STRING", (Object[])null));
      } else if (!isConformantSchemeName(p_scheme)) {
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_SCHEME_NOT_CONFORMANT", (Object[])null));
      } else {
   ...
   public void setHost(String p_host) throws URI.MalformedURIException {
      if (p_host != null && p_host.trim().length() != 0) {
         if (!isWellFormedAddress(p_host)) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_HOST_ADDRESS_NOT_WELLFORMED", (Object[])null));
         }
      } else {
         this.m_host = p_host;
         this.m_userinfo = null;
   ...
   public void setPort(int p_port) throws URI.MalformedURIException {
      if (p_port >= 0 && p_port <= 65535) {
         if (this.m_host == null) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_PORT_WHEN_HOST_NULL", (Object[])null));
         }
      } else if (p_port != -1) {
         throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_INVALID_PORT", (Object[])null));
      }
   ...
   public void appendPath(String p_addToPath) throws URI.MalformedURIException {
      if (p_addToPath != null && p_addToPath.trim().length() != 0) {
         if (!isURIString(p_addToPath)) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_INVALID_CHAR", new Object[]{p_addToPath}));
         } else {
   ...
   public void setFragment(String p_fragment) throws URI.MalformedURIException {
      if (p_fragment == null) {
         ...
         if (!this.isGenericURI()) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_FRAG_FOR_GENERIC_URI", (Object[])null));
         }

         if (this.getPath() == null) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_FRAG_WHEN_PATH_NULL", (Object[])null));
         }

         if (!isURIString(p_fragment)) {
            throw new URI.MalformedURIException(XMLMessages.createXMLMessage("ER_FRAG_INVALID_CHAR", (Object[])null));
         }
