...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xml$utils$ObjectFactory == null ? (class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : class$org$apache$xml$utils$ObjectFactory;
         synchronized(var18) {
