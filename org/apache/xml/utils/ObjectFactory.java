...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xml$utils$ObjectFactory == null ? (class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : class$org$apache$xml$utils$ObjectFactory;
         synchronized(var53) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xml$utils$ObjectFactory == null ? (class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : class$org$apache$xml$utils$ObjectFactory).getClassLoader();
