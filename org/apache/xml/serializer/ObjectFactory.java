...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xml$serializer$ObjectFactory == null ? (class$org$apache$xml$serializer$ObjectFactory = class$("org.apache.xml.serializer.ObjectFactory")) : class$org$apache$xml$serializer$ObjectFactory;
         synchronized(var18) {
