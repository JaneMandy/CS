...
public class SVGImageElementBridge extends AbstractGraphicsNodeBridge {
   ...
   protected GraphicsNode createImageGraphicsNode(BridgeContext var1, Element var2, ParsedURL var3) {
      ...
      if (var4.getWidth() != 0.0D && var4.getHeight() != 0.0D) {
         ...
         if (var47 != null) {
            ...
            SVGImageElementBridge.ProtectedStream var48;
            try {
   ...
   protected SVGImageElementBridge.ProtectedStream openStream(Element var1, ParsedURL var2) throws IOException {
      ...
      return new SVGImageElementBridge.ProtectedStream(var4);
   }
   ...
   protected GraphicsNode createSVGImageNode(BridgeContext var1, Element var2, SVGDocument var3) {
      ...
      if (var6.getWidth() != 0.0D && var6.getHeight() != 0.0D) {
         ...
         if (var1.isInteractive()) {
            this.listener = new SVGImageElementBridge.ForwardEventListener(var8, var2);
   ...
   protected static void initializeViewport(BridgeContext var0, Element var1, GraphicsNode var2, float[] var3, Rectangle2D var4) {
      ...
      try {
         ...
         if (CSSUtilities.convertOverflow(var1)) {
            ...
            if (var13 == null) {
               var12 = new Float(var5, var6, var7, var8);
            } else {
               var12 = new Float(var5 + var13[3], var6 + var13[0], var7 - var13[1] - var13[3], var8 - var13[2] - var13[0]);
            }
         }
   ...
   protected static Rectangle2D getImageBounds(BridgeContext var0, Element var1) {
      try {
         ...
         return new Float(var4, var6, var8, var10);
