...
public class XMLDocumentScannerImpl extends XMLDocumentFragmentScannerImpl {
   ...
   protected XMLDocumentFragmentScannerImpl.Dispatcher fXMLDeclDispatcher = new XMLDocumentScannerImpl.XMLDeclDispatcher();
   protected XMLDocumentFragmentScannerImpl.Dispatcher fPrologDispatcher = new XMLDocumentScannerImpl.PrologDispatcher();
   protected XMLDocumentFragmentScannerImpl.Dispatcher fDTDDispatcher = new XMLDocumentScannerImpl.DTDDispatcher();
   protected XMLDocumentFragmentScannerImpl.Dispatcher fTrailingMiscDispatcher = new XMLDocumentScannerImpl.TrailingMiscDispatcher();
   ...
   protected XMLDocumentFragmentScannerImpl.Dispatcher createContentDispatcher() {
      return new XMLDocumentScannerImpl.ContentDispatcher();
   }
