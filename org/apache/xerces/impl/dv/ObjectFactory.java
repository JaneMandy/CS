...
final class ObjectFactory {
   ...
   static Object createObject(String var0, String var1) throws ObjectFactory.ConfigurationError {
      return createObject(var0, (String)null, var1);
   }

   static Object createObject(String var0, String var1, String var2) throws ObjectFactory.ConfigurationError {
      ...
      if (var1 == null) {
         ...
         Class var54 = class$org$apache$xerces$impl$dv$ObjectFactory == null ? (class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : class$org$apache$xerces$impl$dv$ObjectFactory;
         synchronized(var54) {
            boolean var9 = false;
      ...
      if (var5 != null) {
         ...
         if (var55 != null) {
            ...
            throw new ObjectFactory.ConfigurationError("Provider for " + var0 + " cannot be found", (Exception)null);
         } else {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader var4 = (class$org$apache$xerces$impl$dv$ObjectFactory == null ? (class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : class$org$apache$xerces$impl$dv$ObjectFactory).getClassLoader();
   ...
   static Object newInstance(String var0, ClassLoader var1, boolean var2) throws ObjectFactory.ConfigurationError {
      try {
         Class var3 = findProviderClass(var0, var1, var2);
         Object var4 = var3.newInstance();
         return var4;
      } catch (ClassNotFoundException var5) {
         throw new ObjectFactory.ConfigurationError("Provider " + var0 + " not found", var5);
      } catch (Exception var6) {
         throw new ObjectFactory.ConfigurationError("Provider " + var0 + " could not be instantiated: " + var6, var6);
      }
   }

   static Class findProviderClass(String var0, ClassLoader var1, boolean var2) throws ClassNotFoundException, ObjectFactory.ConfigurationError {
      ...
      if (var1 == null) {
         ...
         try {
            ...
            ClassLoader var6 = (class$org$apache$xerces$impl$dv$ObjectFactory == null ? (class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : class$org$apache$xerces$impl$dv$ObjectFactory).getClassLoader();
            if (var6 == null) {
               var8 = Class.forName(var0);
            } else {
               if (var1 == var6) {
   ...
   private static Object findJarServiceProvider(String var0) throws ObjectFactory.ConfigurationError {
      ...
      if (var3 == null) {
         ClassLoader var5 = (class$org$apache$xerces$impl$dv$ObjectFactory == null ? (class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : class$org$apache$xerces$impl$dv$ObjectFactory).getClassLoader();
         if (var4 != var5) {
            var4 = var5;
