...
public class XMLNSDocumentScannerImpl extends XMLDocumentScannerImpl {
   ...
   protected XMLDocumentFragmentScannerImpl.Dispatcher createContentDispatcher() {
      return new XMLNSDocumentScannerImpl.NSContentDispatcher();
   }
   ...
   protected final class NSContentDispatcher extends XMLDocumentScannerImpl.ContentDispatcher {
      ...
      protected boolean scanRootElementHook() throws IOException, XNIException {
         if (XMLNSDocumentScannerImpl.super.fExternalSubsetResolver != null && !XMLNSDocumentScannerImpl.super.fSeenDoctypeDecl && !XMLNSDocumentScannerImpl.super.fDisallowDoctype && (XMLNSDocumentScannerImpl.super.fValidation || XMLNSDocumentScannerImpl.super.fLoadExternalDTD)) {
            ...
            if (XMLNSDocumentScannerImpl.this.scanStartElementAfterName()) {
               ...
               XMLNSDocumentScannerImpl.this.setDispatcher(XMLNSDocumentScannerImpl.super.fTrailingMiscDispatcher);
               return true;
            }
         } else {
            this.reconfigurePipeline();
