...
class Token implements Serializable {
   ...
   static Token.ParenToken createLook(int var0, Token var1) {
      ++tokens;
      return new Token.ParenToken(var0, var1, 0);
   }

   static Token.ParenToken createParen(Token var0, int var1) {
      ++tokens;
      return new Token.ParenToken(6, var0, var1);
   }

   static Token.ClosureToken createClosure(Token var0) {
      ++tokens;
      return new Token.ClosureToken(3, var0);
   }

   static Token.ClosureToken createNGClosure(Token var0) {
      ++tokens;
      return new Token.ClosureToken(9, var0);
   }

   static Token.ConcatToken createConcat(Token var0, Token var1) {
      ++tokens;
      return new Token.ConcatToken(var0, var1);
   }
   ...
   static Token.CharToken createChar(int var0) {
      ++tokens;
      return new Token.CharToken(0, var0);
   }

   private static Token.CharToken createAnchor(int var0) {
      ++tokens;
      return new Token.CharToken(8, var0);
   }

   static Token.StringToken createBackReference(int var0) {
      ++tokens;
      return new Token.StringToken(12, (String)null, var0);
   }

   static Token.StringToken createString(String var0) {
      ++tokens;
      return new Token.StringToken(10, var0, 0);
   }

   static Token.ModifierToken createModifierGroup(Token var0, int var1, int var2) {
      ++tokens;
      return new Token.ModifierToken(var0, var1, var2);
   }

   static Token.ConditionToken createCondition(int var0, Token var1, Token var2, Token var3) {
      ++tokens;
      return new Token.ConditionToken(var0, var1, var2, var3);
   }
   ...
   final int analyzeFirstCharacter(RangeToken var1, int var2) {
      ...
      case 23:
         return 0;
      case 25:
         var2 |= ((Token.ModifierToken)this).getOptions();
         var2 &= ~((Token.ModifierToken)this).getOptionsMask();
         return this.getChild(0).analyzeFirstCharacter(var1, var2);
      case 26:
   ...
   final void findFixedString(Token.FixedStringContainer var1, int var2) {
      switch(this.type) {
      case 0:
         var1.token = null;
         return;
         ...
         synchronized(var2) {
            ...
            for(int var9 = 0; var9 < blockNames.length; ++var9) {
               ...
               if (var9 < 84) {
                  ...
                  char var13 = "\u0000\u007f\u0080ÿĀſƀɏɐʯʰ˿̀ͯͰϿЀӿ\u0530֏\u0590\u05ff\u0600ۿ܀ݏހ\u07bfऀॿঀ\u09ff\u0a00\u0a7f\u0a80૿\u0b00\u0b7f\u0b80\u0bffఀ౿ಀ\u0cffഀൿ\u0d80\u0dff\u0e00\u0e7f\u0e80\u0effༀ\u0fffက႟Ⴀჿᄀᇿሀ\u137fᎠ\u13ff᐀ᙿ \u169fᚠ\u16ffក\u17ff᠀\u18afḀỿἀ\u1fff \u206f⁰\u209f₠\u20cf⃐\u20ff℀⅏⅐\u218f←⇿∀⋿⌀⏿␀\u243f⑀\u245f①⓿─╿▀▟■◿☀⛿✀➿⠀⣿⺀\u2eff⼀\u2fdf⿰\u2fff　〿\u3040ゟ゠ヿ\u3100ㄯ\u3130\u318f㆐㆟ㆠㆿ㈀㋿㌀㏿㐀䶵一\u9fffꀀ\ua48f꒐\ua4cf가힣\ue000\uf8ff豈\ufaffﬀﭏﭐ\ufdff︠︯︰﹏﹐\ufe6fﹰ\ufefe\ufeff\ufeff\uff00\uffef".charAt(var11 + 1);
               ...
               if (var23.indexOf(32) >= 0) {
                  for(int var25 = 0; var25 < var23.length(); ++var25) {
                     if (var23.charAt(var25) != ' ') {
                        var8.append(var23.charAt(var25));
                     }
                  }
               } else {
                  var8.append(var23);
            ...
            RangeToken var26 = createRange();
            var26.mergeRanges(token_spaces);
            var26.mergeRanges(var3[34]);
            categories.put("IsSpace", var26);
            categories2.put("IsSpace", complementRanges(var26));
   ...
   static synchronized Token getGraphemePattern() {
      if (token_grapheme != null) {
         ...
         Token.UnionToken var4 = createUnion();
         var4.addChild(var0);
         var4.addChild(token_empty);
         Token.UnionToken var5 = createUnion();
         var5.addChild(createConcat(var1, getRange("L", true)));
         var5.addChild(var6);
         Token.ClosureToken var7 = createClosure(var5);
         Token.ConcatToken var8 = createConcat(var4, var7);
         token_grapheme = var8;
         return token_grapheme;
      }
   }
   ...
   static synchronized Token getCombiningCharacterSequence() {
      if (token_ccs != null) {
         ...
         Token.ClosureToken var0 = createClosure(getRange("M", true));
         Token.ConcatToken var1 = createConcat(getRange("M", false), var0);
         token_ccs = var1;
         return token_ccs;
      }
   }
               ...
               if (var1.type == 1) {
                  ...
                  if (var2 == 0) {
                     ...
                     if ((((Token)var3).type == 0 || ((Token)var3).type == 10) && (var1.type == 0 || var1.type == 10)) {
                        ...
                        ((Token.StringToken)var3).string = new String(var4);
                     } else {
                        this.children.addElement(var1);
                     }
                  }
