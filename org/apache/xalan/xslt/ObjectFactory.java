...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xalan$xslt$ObjectFactory;
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xalan$xslt$ObjectFactory == null ? (class$org$apache$xalan$xslt$ObjectFactory = class$("org.apache.xalan.xslt.ObjectFactory")) : class$org$apache$xalan$xslt$ObjectFactory;
         synchronized(var18) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$xslt$ObjectFactory == null ? (class$org$apache$xalan$xslt$ObjectFactory = class$("org.apache.xalan.xslt.ObjectFactory")) : class$org$apache$xalan$xslt$ObjectFactory).getClassLoader();
