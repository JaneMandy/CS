...
public class MethodResolver {
      ...
      if (xsltArgs != null && javaParamTypes != null) {
         ...
         for(int javaParamTypesIndex = javaParamsStart; i < nParams; ++javaParamTypesIndex) {
            ...
            if (xsltClassType == -1) {
               ...
               MethodResolver.ConversionInfo[] convInfo = m_conversions[xsltClassType];
               int nConversions = convInfo.length;

               int k;
               MethodResolver.ConversionInfo realClass;
   ...
   static {
      m_javaObjConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(Double.TYPE, 11), new MethodResolver.ConversionInfo(Float.TYPE, 12), new MethodResolver.ConversionInfo(Long.TYPE, 13), new MethodResolver.ConversionInfo(Integer.TYPE, 14), new MethodResolver.ConversionInfo(Short.TYPE, 15), new MethodResolver.ConversionInfo(Character.TYPE, 16), new MethodResolver.ConversionInfo(Byte.TYPE, 17), new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 18)};
      m_booleanConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(Boolean.TYPE, 0), new MethodResolver.ConversionInfo(class$java$lang$Boolean == null ? (class$java$lang$Boolean = class$("java.lang.Boolean")) : class$java$lang$Boolean, 1), new MethodResolver.ConversionInfo(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 2), new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3)};
      m_numberConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(Double.TYPE, 0), new MethodResolver.ConversionInfo(class$java$lang$Double == null ? (class$java$lang$Double = class$("java.lang.Double")) : class$java$lang$Double, 1), new MethodResolver.ConversionInfo(Float.TYPE, 3), new MethodResolver.ConversionInfo(Long.TYPE, 4), new MethodResolver.ConversionInfo(Integer.TYPE, 5), new MethodResolver.ConversionInfo(Short.TYPE, 6), new MethodResolver.ConversionInfo(Character.TYPE, 7), new MethodResolver.ConversionInfo(Byte.TYPE, 8), new MethodResolver.ConversionInfo(Boolean.TYPE, 9), new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 10), new MethodResolver.ConversionInfo(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 11)};
      m_stringConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 0), new MethodResolver.ConversionInfo(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 1), new MethodResolver.ConversionInfo(Character.TYPE, 2), new MethodResolver.ConversionInfo(Double.TYPE, 3), new MethodResolver.ConversionInfo(Float.TYPE, 3), new MethodResolver.ConversionInfo(Long.TYPE, 3), new MethodResolver.ConversionInfo(Integer.TYPE, 3), new MethodResolver.ConversionInfo(Short.TYPE, 3), new MethodResolver.ConversionInfo(Byte.TYPE, 3), new MethodResolver.ConversionInfo(Boolean.TYPE, 4)};
      m_rtfConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(class$org$w3c$dom$traversal$NodeIterator == null ? (class$org$w3c$dom$traversal$NodeIterator = class$("org.w3c.dom.traversal.NodeIterator")) : class$org$w3c$dom$traversal$NodeIterator, 0), new MethodResolver.ConversionInfo(class$org$w3c$dom$NodeList == null ? (class$org$w3c$dom$NodeList = class$("org.w3c.dom.NodeList")) : class$org$w3c$dom$NodeList, 1), new MethodResolver.ConversionInfo(class$org$w3c$dom$Node == null ? (class$org$w3c$dom$Node = class$("org.w3c.dom.Node")) : class$org$w3c$dom$Node, 2), new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3), new MethodResolver.ConversionInfo(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 5), new MethodResolver.ConversionInfo(Character.TYPE, 6), new MethodResolver.ConversionInfo(Double.TYPE, 7), new MethodResolver.ConversionInfo(Float.TYPE, 7), new MethodResolver.ConversionInfo(Long.TYPE, 7), new MethodResolver.ConversionInfo(Integer.TYPE, 7), new MethodResolver.ConversionInfo(Short.TYPE, 7), new MethodResolver.ConversionInfo(Byte.TYPE, 7), new MethodResolver.ConversionInfo(Boolean.TYPE, 8)};
      m_nodesetConversions = new MethodResolver.ConversionInfo[]{new MethodResolver.ConversionInfo(class$org$w3c$dom$traversal$NodeIterator == null ? (class$org$w3c$dom$traversal$NodeIterator = class$("org.w3c.dom.traversal.NodeIterator")) : class$org$w3c$dom$traversal$NodeIterator, 0), new MethodResolver.ConversionInfo(class$org$w3c$dom$NodeList == null ? (class$org$w3c$dom$NodeList = class$("org.w3c.dom.NodeList")) : class$org$w3c$dom$NodeList, 1), new MethodResolver.ConversionInfo(class$org$w3c$dom$Node == null ? (class$org$w3c$dom$Node = class$("org.w3c.dom.Node")) : class$org$w3c$dom$Node, 2), new MethodResolver.ConversionInfo(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3), new MethodResolver.ConversionInfo(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 5), new MethodResolver.ConversionInfo(Character.TYPE, 6), new MethodResolver.ConversionInfo(Double.TYPE, 7), new MethodResolver.ConversionInfo(Float.TYPE, 7), new MethodResolver.ConversionInfo(Long.TYPE, 7), new MethodResolver.ConversionInfo(Integer.TYPE, 7), new MethodResolver.ConversionInfo(Short.TYPE, 7), new MethodResolver.ConversionInfo(Byte.TYPE, 7), new MethodResolver.ConversionInfo(Boolean.TYPE, 8)};
      m_conversions = new MethodResolver.ConversionInfo[][]{m_javaObjConversions, m_booleanConversions, m_numberConversions, m_stringConversions, m_nodesetConversions, m_rtfConversions};
   }
