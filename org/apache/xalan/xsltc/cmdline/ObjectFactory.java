...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xalan$xsltc$cmdline$ObjectFactory;
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$xsltc$cmdline$ObjectFactory == null ? (class$org$apache$xalan$xsltc$cmdline$ObjectFactory = class$("org.apache.xalan.xsltc.cmdline.ObjectFactory")) : class$org$apache$xalan$xsltc$cmdline$ObjectFactory).getClassLoader();
