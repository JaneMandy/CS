...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xalan$xsltc$trax$ObjectFactory == null ? (class$org$apache$xalan$xsltc$trax$ObjectFactory = class$("org.apache.xalan.xsltc.trax.ObjectFactory")) : class$org$apache$xalan$xsltc$trax$ObjectFactory;
         synchronized(var53) {
