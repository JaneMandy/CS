...
class FunctionCall extends Expression {
      ...
      if (constructors == null) {
         ...
         for(int i = 0; i < nConstructors; ++i) {
            ...
            for(j = 0; j < nArgs; ++j) {
               ...
               if (match != null) {
                  currConstrDistance += ((FunctionCall.JavaType)match).distance;
               } else {
         ...
         if (methods == null) {
            ...
            for(int i = 0; i < nMethods; ++i) {
               ...
               for(j = 0; j < nArgs; ++j) {
                  ...
                  Object match = _internal2Java.maps(intType, extType);
                  if (match != null) {
                     currMethodDistance += ((FunctionCall.JavaType)match).distance;
   ...
   static {
      try {
         ...
         _internal2Java.put(Type.Boolean, new FunctionCall.JavaType(Boolean.TYPE, 0));
         _internal2Java.put(Type.Boolean, new FunctionCall.JavaType(class$java$lang$Boolean == null ? (class$java$lang$Boolean = class$("java.lang.Boolean")) : class$java$lang$Boolean, 1));
         _internal2Java.put(Type.Boolean, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 2));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Double.TYPE, 0));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(class$java$lang$Double == null ? (class$java$lang$Double = class$("java.lang.Double")) : class$java$lang$Double, 1));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Float.TYPE, 2));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Long.TYPE, 3));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Integer.TYPE, 4));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Short.TYPE, 5));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Byte.TYPE, 6));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(Character.TYPE, 7));
         _internal2Java.put(Type.Real, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 8));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Double.TYPE, 0));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(class$java$lang$Double == null ? (class$java$lang$Double = class$("java.lang.Double")) : class$java$lang$Double, 1));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Float.TYPE, 2));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Long.TYPE, 3));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Integer.TYPE, 4));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Short.TYPE, 5));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Byte.TYPE, 6));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(Character.TYPE, 7));
         _internal2Java.put(Type.Int, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 8));
         _internal2Java.put(Type.String, new FunctionCall.JavaType(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 0));
         _internal2Java.put(Type.String, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 1));
         _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(nodeListClass, 0));
         _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(nodeClass, 1));
         _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 2));
         _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3));
         _internal2Java.put(Type.Node, new FunctionCall.JavaType(nodeListClass, 0));
         _internal2Java.put(Type.Node, new FunctionCall.JavaType(nodeClass, 1));
         _internal2Java.put(Type.Node, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 2));
         _internal2Java.put(Type.Node, new FunctionCall.JavaType(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3));
         _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(nodeListClass, 0));
         _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(nodeClass, 1));
         _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 2));
         _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, 3));
         _internal2Java.put(Type.Reference, new FunctionCall.JavaType(class$java$lang$Object == null ? (class$java$lang$Object = class$("java.lang.Object")) : class$java$lang$Object, 0));
