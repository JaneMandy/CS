...
public final class ErrorMsg {
   ...
   private String getFileName(SyntaxTreeNode node) {
      ...
      return stylesheet != null ? stylesheet.getSystemId() : null;
   }
   ...
   public String toString() {
      String suffix = this._params == null ? (null != this._code ? new String(this.getErrorMessage()) : this._message) : MessageFormat.format(this.getErrorMessage(), this._params);
