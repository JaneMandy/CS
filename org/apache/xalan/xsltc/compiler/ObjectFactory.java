...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xalan$xsltc$compiler$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$ObjectFactory;
         synchronized(var53) {
