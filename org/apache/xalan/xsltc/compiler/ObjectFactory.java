...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xalan$xsltc$compiler$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$ObjectFactory;
         synchronized(var18) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$xsltc$compiler$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$ObjectFactory).getClassLoader();
