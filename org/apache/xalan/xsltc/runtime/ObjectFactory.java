...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xalan$xsltc$runtime$ObjectFactory;
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xalan$xsltc$runtime$ObjectFactory == null ? (class$org$apache$xalan$xsltc$runtime$ObjectFactory = class$("org.apache.xalan.xsltc.runtime.ObjectFactory")) : class$org$apache$xalan$xsltc$runtime$ObjectFactory;
         synchronized(var53) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$xsltc$runtime$ObjectFactory == null ? (class$org$apache$xalan$xsltc$runtime$ObjectFactory = class$("org.apache.xalan.xsltc.runtime.ObjectFactory")) : class$org$apache$xalan$xsltc$runtime$ObjectFactory).getClassLoader();
