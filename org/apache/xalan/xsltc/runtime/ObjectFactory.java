...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xalan$xsltc$runtime$ObjectFactory == null ? (class$org$apache$xalan$xsltc$runtime$ObjectFactory = class$("org.apache.xalan.xsltc.runtime.ObjectFactory")) : class$org$apache$xalan$xsltc$runtime$ObjectFactory;
         synchronized(var18) {
