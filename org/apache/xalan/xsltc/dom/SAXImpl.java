...
public final class SAXImpl extends SAX2DTM2 implements DOMEnhancedForDTM, DOMBuilder {
   ...
   public DTMAxisIterator getNodeValueIterator(DTMAxisIterator iterator, int type, String value, boolean op) {
      return new SAXImpl.NodeValueIterator(iterator, type, value, op);
   }
   ...
   public DTMAxisIterator getNamespaceAxisIterator(int axis, int ns) {
      ...
      if (ns == -1) {
         ...
         switch(axis) {
         case 2:
            return new SAXImpl.NamespaceAttributeIterator(ns);
         case 3:
            return new SAXImpl.NamespaceChildrenIterator(ns);
         default:
            return new SAXImpl.NamespaceWildcardIterator(axis, ns);
         }
      }
   }
   ...
   public final class NamespaceWildcardIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         try {
            ...
            SAXImpl.NamespaceWildcardIterator clone = (SAXImpl.NamespaceWildcardIterator)super.clone();
   ...
   private final class NodeValueIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         try {
            SAXImpl.NodeValueIterator clone = (SAXImpl.NodeValueIterator)super.clone();
            clone._isRestartable = false;
