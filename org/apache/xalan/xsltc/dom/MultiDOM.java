...
public final class MultiDOM implements DOM {
   ...
   public DTMAxisIterator getTypedChildren(int type) {
      return new MultiDOM.AxisIterator(3, type);
   }

   public DTMAxisIterator getAxisIterator(int axis) {
      return new MultiDOM.AxisIterator(axis, -2);
   }

   public DTMAxisIterator getTypedAxisIterator(int axis, int type) {
      return new MultiDOM.AxisIterator(axis, type);
   }
   ...
   public DTMAxisIterator getNodeValueIterator(DTMAxisIterator iterator, int type, String value, boolean op) {
      return new MultiDOM.NodeValueIterator(iterator, type, value, op);
   }
   ...
   private final class NodeValueIterator extends DTMAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         try {
            MultiDOM.NodeValueIterator clone = (MultiDOM.NodeValueIterator)super.clone();
   ...
   private final class AxisIterator extends DTMAxisIteratorBase {
      ...
      public DTMAxisIterator cloneIterator() {
         MultiDOM.AxisIterator clone = MultiDOM.this.new AxisIterator(this._axis, this._type);
         if (this._source != null) {
            clone._source = this._source.cloneIterator();
         }
