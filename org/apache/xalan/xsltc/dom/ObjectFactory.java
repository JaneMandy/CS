...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xalan$xsltc$dom$ObjectFactory == null ? (class$org$apache$xalan$xsltc$dom$ObjectFactory = class$("org.apache.xalan.xsltc.dom.ObjectFactory")) : class$org$apache$xalan$xsltc$dom$ObjectFactory;
         synchronized(var18) {
