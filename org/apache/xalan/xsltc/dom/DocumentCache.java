...
public final class DocumentCache implements DOMCache {
   ...
   private DocumentCache.CachedDocument lookupDocument(String uri) {
      return (DocumentCache.CachedDocument)this._references.get(uri);
   }

   private synchronized void insertDocument(String uri, DocumentCache.CachedDocument doc) {
   ...
   private synchronized void replaceDocument(String uri, DocumentCache.CachedDocument doc) {
      DocumentCache.CachedDocument old = (DocumentCache.CachedDocument)this._references.get(uri);
      if (doc == null) {
   ...
   public DOM retrieveDocument(String baseURI, String href, Translet trs) {
      ...
      if ((doc = this.lookupDocument(uri)) == null) {
         doc = new DocumentCache.CachedDocument(uri);
         if (doc == null) {
            return null;
         }
   ...
   public void getStatistics(PrintWriter out) {
      ...
      for(int i = 0; i < this._count; ++i) {
         DocumentCache.CachedDocument doc = (DocumentCache.CachedDocument)this._references.get(this._URIs[i]);
