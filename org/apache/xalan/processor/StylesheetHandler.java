...
public class StylesheetHandler extends DefaultHandler implements TemplatesHandler, PrefixResolver, NodeConsumer {
   ...
   XSLTElementProcessor getProcessorFor(String uri, String localName, String rawName) throws SAXException {
      ...
      if (null == elemProcessor && !(currentProcessor instanceof ProcessorStylesheetDoc) && (null == this.getStylesheet() || Double.valueOf(this.getStylesheet().getVersion()) > 1.0D || !uri.equals("http://www.w3.org/1999/XSL/Transform") && currentProcessor instanceof ProcessorStylesheetElement || this.getElemVersion() > 1.0D)) {
