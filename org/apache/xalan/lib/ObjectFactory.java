...
class ObjectFactory {
   ...
   // $FF: synthetic field
   static Class class$org$apache$xalan$lib$ObjectFactory;
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var18 = class$org$apache$xalan$lib$ObjectFactory == null ? (class$org$apache$xalan$lib$ObjectFactory = class$("org.apache.xalan.lib.ObjectFactory")) : class$org$apache$xalan$lib$ObjectFactory;
         synchronized(var18) {
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$lib$ObjectFactory == null ? (class$org$apache$xalan$lib$ObjectFactory = class$("org.apache.xalan.lib.ObjectFactory")) : class$org$apache$xalan$lib$ObjectFactory).getClassLoader();
