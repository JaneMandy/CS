...
class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         Class var53 = class$org$apache$xalan$lib$ObjectFactory == null ? (class$org$apache$xalan$lib$ObjectFactory = class$("org.apache.xalan.lib.ObjectFactory")) : class$org$apache$xalan$lib$ObjectFactory;
         synchronized(var53) {
