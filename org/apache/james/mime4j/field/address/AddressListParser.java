...
public class AddressListParser implements AddressListParserTreeConstants, AddressListParserConstants {
   ...
   private int jj_gc;
   private final AddressListParser.LookaheadSuccess jj_ls;
   ...
   private boolean jj_2_1(int xla) {
      ...
      try {
         ...
         return var2;
      } catch (AddressListParser.LookaheadSuccess var7) {
         var3 = true;
      } finally {
         this.jj_save(0, xla);
      }
   ...
   public AddressListParser(InputStream stream, String encoding) {
      ...
      this.jj_2_rtns = new AddressListParser.JJCalls[2];
      this.jj_rescan = false;
      this.jj_gc = 0;
      this.jj_ls = new AddressListParser.LookaheadSuccess();
      ...
      for(i = 0; i < this.jj_2_rtns.length; ++i) {
         this.jj_2_rtns[i] = new AddressListParser.JJCalls();
      }
      ...
      if (this.token.kind != kind) {
         ...
         if (++this.jj_gc > 100) {
            ...
            for(int i = 0; i < this.jj_2_rtns.length; ++i) {
               for(AddressListParser.JJCalls c = this.jj_2_rtns[i]; c != null; c = c.next) {
   ...
   private void jj_rescan_token() {
      ...
      for(int i = 0; i < 2; ++i) {
         try {
            AddressListParser.JJCalls p = this.jj_2_rtns[i];
         ...
         } catch (AddressListParser.LookaheadSuccess var3) {
         }
      }
   ...
   private void jj_save(int index, int xla) {
      AddressListParser.JJCalls p;
      for(p = this.jj_2_rtns[index]; p.gen > this.jj_gen; p = p.next) {
         if (p.next == null) {
            p = p.next = new AddressListParser.JJCalls();
            break;
         }
      }
   ...
   static final class JJCalls {
      ...
      Token first;
      int arg;
      AddressListParser.JJCalls next;
   }
