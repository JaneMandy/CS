...
final class ObjectFactory {
   ...
   static Object createObject(String var0, String var1, String var2) throws ObjectFactory.ConfigurationError {
      ...
      if (var1 == null) {
         ...
         Class var54 = class$org$apache$html$dom$ObjectFactory == null ? (class$org$apache$html$dom$ObjectFactory = class$("org.apache.html.dom.ObjectFactory")) : class$org$apache$html$dom$ObjectFactory;
         synchronized(var54) {
            boolean var9 = false;
   ...
   static ClassLoader findClassLoader() throws ObjectFactory.ConfigurationError {
      ...
      ClassLoader var4 = (class$org$apache$html$dom$ObjectFactory == null ? (class$org$apache$html$dom$ObjectFactory = class$("org.apache.html.dom.ObjectFactory")) : class$org$apache$html$dom$ObjectFactory).getClassLoader();
   ...
   static Class findProviderClass(String var0, ClassLoader var1, boolean var2) throws ClassNotFoundException, ObjectFactory.ConfigurationError {
      ...
      if (var1 == null) {
         ...
         try {
            ...
            ClassLoader var6 = (class$org$apache$html$dom$ObjectFactory == null ? (class$org$apache$html$dom$ObjectFactory = class$("org.apache.html.dom.ObjectFactory")) : class$org$apache$html$dom$ObjectFactory).getClassLoader();
            if (var6 == null) {
               var8 = Class.forName(var0);
            } else {
               if (var1 == var6) {
   ...
   private static Object findJarServiceProvider(String var0) throws ObjectFactory.ConfigurationError {
      ...
      if (var3 == null) {
         ClassLoader var5 = (class$org$apache$html$dom$ObjectFactory == null ? (class$org$apache$html$dom$ObjectFactory = class$("org.apache.html.dom.ObjectFactory")) : class$org$apache$html$dom$ObjectFactory).getClassLoader();
         if (var4 != var5) {
            var4 = var5;
